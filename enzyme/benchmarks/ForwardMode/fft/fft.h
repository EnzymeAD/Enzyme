...
/*
  Differentiation of recursiveApply in reverse (adjoint) mode (with options
  context): gradient     of useful results: *data with respect to varying
  inputs: *data Plus diff mem management of: data:in
*/
static void recursiveApply_b(double *data, double *datab, int iSign,
                             unsigned int N) {
  int arg1;
  double *arg10;
  double *arg10b;
