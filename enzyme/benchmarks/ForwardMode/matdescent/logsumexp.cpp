...
static adouble amax(adouble x, adouble y) { return (x > y) ? x : y; }
...
*/
static void logsumexp_b(const double *__restrict x, double *xb, size_t n,
                        double logsumexpb) {
  double A = x[0];
  double Ab = 0.0;
  int branch;
...
static void adept_sincos(double *input, double *inputp, unsigned long n,
...
static void adept2_sincos(double *input, double *inputp, unsigned long n,
                          unsigned long repeat) {
  {
    struct timeval start, end;
    // gettimeofday(&start, NULL);
...
static void enzyme_sincos(double *input, double *inputp, unsigned long n,
                          unsigned long repeat) {
...
static void tapenade_sincos(double *input, double *inputp, unsigned long n,
                            unsigned long repeat) {
  double realinput = input[0];
  {
    struct timeval start, end;
