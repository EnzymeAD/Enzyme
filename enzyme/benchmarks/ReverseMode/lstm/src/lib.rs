...
#[no_mangle]
pub extern "C" fn rust_safe_lstm_objective(l: i32, c: i32, b: i32, main_params: *mut f64, extra_params: *mut f64, state: *mut f64, sequence: *mut f64, loss: *mut f64) {
    let l = l as usize;
    let c = c as usize;
    let b = b as usize;
...
#[no_mangle]
pub extern "C" fn rust_safe_dlstm_objective(l: i32, c: i32, b: i32, main_params: *mut f64, d_main_params: *mut f64, extra_params: *mut f64, d_extra_params: *mut f64, state: *mut f64, sequence: *mut f64, res: *mut f64, d_res: *mut f64) {
    let l = l as usize;
    let c = c as usize;
    let b = b as usize;
