...
foreach(file ${BLAS_LL})
  ...
  file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/blas_headers.h
       "const char __data_${variableName}[] = {${arrayValues}};\n")
endforeach()
...
foreach(file ${BLAS64_LL})
  ...
  file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/blas_headers.h
       "const char __data_${variableName}64_[] = {${arrayValues}};\n")
endforeach()
...
foreach(file ${BLAS64_LL})
  ...
  set(arrayDefinition
      "{ \"cblas_${variableName}64_\",  __data_${variableName}64_ }")
  file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/blas_headers.h "${arrayDefinition}")
  set(NEED_COMMA TRUE)
endforeach()
...
file(
  READ "${CMAKE_CURRENT_SOURCE_DIR}/../fblas/src/fblas/bclib32.ll" hexString
  HEX)
set(hexString "${hexString}00")
string(REGEX REPLACE "([0-9a-f][0-9a-f])" "0x\\1," arrayValues ${hexString})
string(REGEX REPLACE ",$" "" arrayValues ${arrayValues})
file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/blas_headers.h
     "const char __data_fblas32[] = {${arrayValues}};\n")

file(
  READ "${CMAKE_CURRENT_SOURCE_DIR}/../fblas/src/fblas/bclib64.ll" hexString
  HEX)
set(hexString "${hexString}00")
string(REGEX REPLACE "([0-9a-f][0-9a-f])" "0x\\1," arrayValues ${hexString})
string(REGEX REPLACE ",$" "" arrayValues ${arrayValues})
file(APPEND ${CMAKE_CURRENT_SOURCE_DIR}/blas_headers.h
     "const char __data_fblas64[] = {${arrayValues}};\n")
