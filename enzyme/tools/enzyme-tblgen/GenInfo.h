...
#ifndef ENZYME_TABLEGEN_GENINFO_H_
#define ENZYME_TABLEGEN_GENINFO_H_
...
/// enzyme-tblgen, description, and generator function).
class GenInfo {
public:
  ...
  /// Returns the command line option that may be passed to 'enzyme-tblgen' to
...
#endif // ENZYME_TABLEGEN_GENINFO_H_
