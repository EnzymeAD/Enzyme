...
start:
  ...
  call void @llvm.dbg.declare(metadata double* %x.dbg.spill, metadata !170, metadata !DIExpression()), !dbg !171
  ret void
}
...
!19 = !DIFile(filename: "rustf64.rs", directory: "/home/nomanous/Space/Tmp/EnzymeTest")
!20 = !{!0}
...
!164 = !DIFile(filename: "rustf64.rs", directory: "/home/nomanous/Space/Tmp/EnzymeTest", checksumkind: CSK_MD5, checksum: "c93681e50c369923547910dce138971d")
!165 = !DINamespace(name: "rustf64", scope: null)
!166 = !DISubroutineType(types: !167)
!167 = !{!168, !168}
!168 = !DIBasicType(name: "f64", size: 64, encoding: DW_ATE_float)
!169 = !{!170}
...
; CHECK-NEXT: i8* %x: {[-1]:Pointer, [-1,0]:Float@double}
; CHECK-NEXT: start
; CHECK-NEXT:   %x.dbg.spill = bitcast i8* %x to double*: {[-1]:Pointer, [-1,0]:Float@double}
; CHECK-NEXT:   call void @llvm.dbg.declare(metadata double* %x.dbg.spill, metadata !21, metadata !DIExpression()), !dbg !29: {}
; CHECK-NEXT:   ret void: {}
