...
; Here the two phis list their predecessors in opposite order, the edges must
; be paired by incoming block and not by operand index.
...
; CHECK-NEXT:   %off = phi i64 [ 0, %b ], [ 8, %a ]: {[-1]:Integer}
