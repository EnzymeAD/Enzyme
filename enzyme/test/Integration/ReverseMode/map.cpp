// RUN: %clang++ -std=c++11 -fno-exceptions -ffast-math -O0 %s -S -emit-llvm -o - | %opt - %loadEnzyme %enzyme -enzyme-loose-types -S | %lli -
...
// RUN: %clang++ -std=c++11 -fno-exceptions -ffast-math -O0 %s -S -emit-llvm -o - | %opt - %loadEnzyme %enzyme -enzyme-inline=1 -enzyme-loose-types -S | %lli -
