...
; CHECK-NEXT:   %3 = load double, double* %xp1, align 8
; CHECK-NEXT:   %4 = load double, double* %xp2, align 8
; CHECK-NEXT:   %5 = load double, double* %xp3, align 8
; CHECK-NEXT:   store double 0.000000e+00, double* %xp1, align 8
; CHECK-NEXT:   store double 0.000000e+00, double* %xp2, align 8
; CHECK-NEXT:   store double 0.000000e+00, double* %xp3, align 8
...
; CHECK-NEXT:   %29 = load double, double* %xp1, align 8
; CHECK-NEXT:   %30 = load double, double* %xp2, align 8
...
; CHECK-NEXT:   store double %32, double* %xp1, align 8
; CHECK-NEXT:   store double %34, double* %xp2, align 8
; CHECK-NEXT:   store double %35, double* %xp3, align 8
