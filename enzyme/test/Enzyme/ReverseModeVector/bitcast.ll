...
; CHECK-NEXT: entry:
; CHECK-NEXT:   %"y'de" = alloca [2 x i64], align 8
; CHECK-NEXT:   store [2 x i64] zeroinitializer, [2 x i64]* %"y'de", align 4
; CHECK-NEXT:   %"x'de" = alloca [2 x double], align 8
; CHECK-NEXT:   store [2 x double] zeroinitializer, [2 x double]* %"x'de", align 8
...
; CHECK-NEXT:   store i64 %6, i64* %2, align 4
...
; CHECK-NEXT:   store i64 %11, i64* %7, align 4
; CHECK-NEXT:   %12 = load [2 x i64], [2 x i64]* %"y'de", align 4
...
; CHECK-NEXT:   %21 = load double, double* %20, align 8
; CHECK-NEXT:   %22 = fadd fast double %21, %16
; CHECK-NEXT:   store double %22, double* %20, align 8
; CHECK-NEXT:   store [2 x i64] zeroinitializer, [2 x i64]* %"y'de", align 4
; CHECK-NEXT:   %23 = load [2 x double], [2 x double]* %"x'de", align 8
