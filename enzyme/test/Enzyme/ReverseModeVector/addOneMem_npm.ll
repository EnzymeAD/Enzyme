...
; CHECK-NEXT: entry:
; CHECK-NEXT:   %"add'de.i" = alloca [3 x double], align 8
; CHECK-NEXT:   %"'de.i" = alloca [3 x double], align 8
...
; CHECK-NEXT:   store [3 x double] zeroinitializer, [3 x double]* %"add'de.i", align 8
; CHECK-NEXT:   store [3 x double] zeroinitializer, [3 x double]* %"'de.i", align 8
...
; CHECK-NEXT:   %3 = load double, double* %xp1, align 8, !noalias !7
; CHECK-NEXT:   %4 = load double, double* %xp2, align 8, !noalias !7
; CHECK-NEXT:   %5 = load double, double* %xp3, align 8, !noalias !7
...
; CHECK-NEXT:   store double %14, double* %12, align 8
; CHECK-NEXT:   %15 = load [3 x double], [3 x double]* %"add'de.i", align 8
...
; CHECK-NEXT:   store double %27, double* %25, align 8
; CHECK-NEXT:   %28 = load [3 x double], [3 x double]* %"'de.i", align 8
; CHECK-NEXT:   %29 = extractvalue [3 x double] %28, 0
; CHECK-NEXT:   store double %29, double* %xp1, align 8, !alias.scope !8, !noalias !9
; CHECK-NEXT:   %30 = extractvalue [3 x double] %28, 1
; CHECK-NEXT:   store double %30, double* %xp2, align 8, !alias.scope !10, !noalias !11
; CHECK-NEXT:   %31 = extractvalue [3 x double] %28, 2
; CHECK-NEXT:   store double %31, double* %xp3, align 8, !alias.scope !12, !noalias !13
