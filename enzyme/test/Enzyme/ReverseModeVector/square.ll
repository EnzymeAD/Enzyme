...
; CHECK-NEXT:   %10 = load double, double* %4, align 8
; CHECK-NEXT:   %11 = fadd fast double %10, %m0diffex
; CHECK-NEXT:   store double %11, double* %4, align 8
; CHECK-NEXT:   %12 = load double, double* %7, align 8
; CHECK-NEXT:   %13 = fadd fast double %12, %m0diffex1
; CHECK-NEXT:   store double %13, double* %7, align 8
; CHECK-NEXT:   %14 = load [2 x double], [2 x double]* %"x'de", align 8
