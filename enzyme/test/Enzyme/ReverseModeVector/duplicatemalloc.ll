...
; RUN: if [ %llvmver -ge 14 ]; then %opt < %s %newLoadEnzyme -passes="enzyme,inline,function(mem2reg,sroa,simplifycfg,instsimplify,early-cse,adce,dse)" -enzyme-preopt=false -S | FileCheck %s -check-prefixes CALLOC,SHARED; fi
