...
; CHECK-NEXT:   %6 = select i1 %2, <2 x double> %5, <2 x double> %4
...
; CHECK-NEXT:   %10 = select i1 %2, <2 x double> %9, <2 x double> %8
...
; CHECK-NEXT:   %14 = select i1 %2, <2 x double> %13, <2 x double> %12
; CHECK-NEXT:   %15 = fadd <2 x double> zeroinitializer, %6
; CHECK-NEXT:   %16 = fadd <2 x double> zeroinitializer, %10
; CHECK-NEXT:   %17 = fadd <2 x double> zeroinitializer, %14
