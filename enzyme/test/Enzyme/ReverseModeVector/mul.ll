...
; CHECK-NEXT:   %"y'de" = alloca [2 x double], align 8
; CHECK-NEXT:   store [2 x double] zeroinitializer, [2 x double]* %"y'de", align 8
...
; CHECK-NEXT:   %18 = load [2 x double], [2 x double]* %"x'de", align 8
; CHECK-NEXT:   %19 = load [2 x double], [2 x double]* %"y'de", align 8
