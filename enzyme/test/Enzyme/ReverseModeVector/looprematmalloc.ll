...
; CHECK-NEXT:   %i18 = call fast double @llvm.powi.f64(double %arg, i32 %i17)
...
; CHECK-NEXT:   %.fca.0.insert146 = insertvalue [3 x double] undef, double %"arg'de.sroa.0.0", 0
; CHECK-NEXT:   %.fca.1.insert148 = insertvalue [3 x double] %.fca.0.insert146, double %"arg'de.sroa.5.0", 1
; CHECK-NEXT:   %.fca.2.insert150 = insertvalue [3 x double] %.fca.1.insert148, double %"arg'de.sroa.10.0", 2
; CHECK-NEXT:   %0 = insertvalue { [3 x double] } undef, [3 x double] %.fca.2.insert150, 0
...
; CHECK-NEXT:   %.fca.0.insert128 = insertvalue [3 x double] undef, double %"i10'de.sroa.0.0", 0
; CHECK-NEXT:   %.fca.1.insert130 = insertvalue [3 x double] %.fca.0.insert128, double %"i10'de.sroa.7.0", 1
; CHECK-NEXT:   %.fca.2.insert132 = insertvalue [3 x double] %.fca.1.insert130, double %"i10'de.sroa.14.0", 2
; CHECK-NEXT:   %1 = icmp eq i64 %"iv'ac.0", 0
; CHECK-NEXT:   %2 = xor i1 %1, true
; CHECK-NEXT:   %3 = select {{(fast )?}}i1 %2, [3 x double] %.fca.2.insert132, [3 x double] zeroinitializer
...
; CHECK-NEXT:   %11 = call fast double @llvm.powi.f64(double %arg, i32 %10)
; CHECK-NEXT:   %12 = fmul fast double %35, %11
; CHECK-NEXT:   %13 = sitofp i32 %i17_unwrap6 to double
; CHECK-NEXT:   %14 = fmul fast double %12, %13
; CHECK-NEXT:   %15 = insertvalue [3 x double] undef, double %14, 0
; CHECK-NEXT:   %16 = fmul fast double %37, %11
; CHECK-NEXT:   %17 = fmul fast double %16, %13
; CHECK-NEXT:   %18 = insertvalue [3 x double] %15, double %17, 1
; CHECK-NEXT:   %19 = fmul fast double %39, %11
; CHECK-NEXT:   %20 = fmul fast double %19, %13
...
; CHECK-NEXT:   %"i20'ipg_unwrap" = getelementptr inbounds [30 x double], [30 x double]* %"i'ipc_unwrap32", i64 0, i64 %"iv1'ac.0"
; CHECK-NEXT:   %"i20'ipg9_unwrap" = getelementptr inbounds [30 x double], [30 x double]* %"i'ipc7_unwrap35", i64 0, i64 %"iv1'ac.0"
; CHECK-NEXT:   %"i20'ipg10_unwrap" = getelementptr inbounds [30 x double], [30 x double]* %"i'ipc8_unwrap38", i64 0, i64 %"iv1'ac.0"
...
; CHECK-NEXT:   %.fca.0.insert99 = insertvalue [3 x double] undef, double %30, 0
; CHECK-NEXT:   %.fca.1.insert102 = insertvalue [3 x double] %.fca.0.insert99, double %31, 1
; CHECK-NEXT:   %.fca.2.insert105 = insertvalue [3 x double] %.fca.1.insert102, double %32, 2
; CHECK-NEXT:   %i15_unwrap22 = and i64 %"iv1'ac.0", 1
; CHECK-NEXT:   %i16_unwrap23 = icmp eq i64 %i15_unwrap22, 0
; CHECK-NEXT:   %33 = select {{(fast )?}}i1 %i16_unwrap23, [3 x double] %.fca.2.insert105, [3 x double] zeroinitializer
...
; CHECK-NEXT:   br i1 %i16_unwrap23, label %invertif.true, label %invertsetLoop
...
; CHECK-NEXT:   %i15_unwrap3 = and i64 %fiv, 1
; CHECK-NEXT:   %i16_unwrap4 = icmp eq i64 %i15_unwrap3, 0
; CHECK-NEXT:   %i17_unwrap = trunc i64 %fiv to i32
; CHECK-NEXT:   %41 = call fast double @llvm.powi.f64(double %arg, i32 %i17_unwrap)
; CHECK-NEXT:   %42 = select i1 %i16_unwrap4, double %41, double 0.000000e+00
...
; CHECK-NEXT:   %m0diffei825 = fmul fast double %"i10'de.sroa.7.0", %i8_unwrap
; CHECK-NEXT:   %m0diffei826 = fmul fast double %"i10'de.sroa.14.0", %i8_unwrap
; CHECK-NEXT:   %43 = fadd fast double %m0diffei8, %m0diffei8
; CHECK-NEXT:   %44 = fadd fast double %m0diffei825, %m0diffei825
; CHECK-NEXT:   %45 = fadd fast double %m0diffei826, %m0diffei826
; CHECK-NEXT:   %"i'ipc_unwrap32" = bitcast i8* %"i1'mi" to [30 x double]*
; CHECK-NEXT:   %"i'ipc7_unwrap35" = bitcast i8* %"i1'mi1" to [30 x double]*
; CHECK-NEXT:   %"i'ipc8_unwrap38" = bitcast i8* %"i1'mi2" to [30 x double]*
; CHECK-NEXT:   %"i7'ipg_unwrap" = getelementptr inbounds [30 x double], [30 x double]* %"i'ipc_unwrap32", i64 0, i64 %"iv'ac.0"
; CHECK-NEXT:   %"i7'ipg29_unwrap" = getelementptr inbounds [30 x double], [30 x double]* %"i'ipc7_unwrap35", i64 0, i64 %"iv'ac.0"
; CHECK-NEXT:   %"i7'ipg30_unwrap" = getelementptr inbounds [30 x double], [30 x double]* %"i'ipc8_unwrap38", i64 0, i64 %"iv'ac.0"
; CHECK-NEXT:   %46 = load double, double* %"i7'ipg_unwrap"
; CHECK-NEXT:   %47 = load double, double* %"i7'ipg29_unwrap"
; CHECK-NEXT:   %48 = load double, double* %"i7'ipg30_unwrap"
...
; CHECK-NEXT:   store double %50, double* %"i7'ipg29_unwrap"
; CHECK-NEXT:   store double %51, double* %"i7'ipg30_unwrap"
; CHECK-NEXT:   br label %invertsetExit
; CHECK-NEXT: }