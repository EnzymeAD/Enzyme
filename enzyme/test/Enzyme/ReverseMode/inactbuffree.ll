...
; CHECK-NEXT:   tail call void @nofree_dealloc(double* nonnull %call)
; CHECK-NEXT:   %0 = fmul fast double %differeturn, %ld
; CHECK-NEXT:   call void @diffealloc(i8* %subcache)
...
; CHECK-NEXT: define internal void @diffealloc(i8* %call)
; CHECK-NEXT: entry:
