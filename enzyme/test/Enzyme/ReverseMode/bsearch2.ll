...
; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,function(inline,mem2reg,gvn,instsimplify,adce,correlated-propagation,simplifycfg)" -enzyme-preopt=false -S | FileCheck %s
