...
loop:
  ...
  %v2 = fmul double %v, %v
  store double %v2, double* %out, !alias.scope !14, !noalias !104
...
; CHECK-NEXT: invertloop:                                       ; preds = %loop, %incinvertloop
...
; CHECK-NEXT:   store double 0.000000e+00, double* %"out'il_phi_unwrap", align 8, !alias.scope !18, !noalias !20
...
; CHECK-NEXT:   %2 = load double, double* %"in'il_phi_unwrap", align 8, !alias.scope !18, !noalias !21
; CHECK-NEXT:   %3 = fadd fast double %2, %1
; CHECK-NEXT:   store double %3, double* %"in'il_phi_unwrap", align 8, !alias.scope !18, !noalias !21
