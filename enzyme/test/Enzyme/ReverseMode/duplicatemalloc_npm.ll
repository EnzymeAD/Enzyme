...
; CHECK-NEXT:    store double %x, double* %0, align 8, !tbaa !2, !alias.scope !6, !noalias !9
; CHECK-NEXT:    %call1.i = call fast double @augmented_f(double* %0, double* %"'ipc.i") #4
; CHECK-NEXT:    %1 = fadd fast double %call1.i, %call1.i
; CHECK-NEXT:    call void @diffef(double* %0, double* %"'ipc.i", double %1) #4
; CHECK-NEXT:    store double 0.000000e+00, double* %"'ipc.i", align 8, !tbaa !2, !alias.scope !9, !noalias !6
...
; CHECK-NEXT: entry:
; CHECK-NEXT:   %0 = load double, double* %"x'", align 8, !tbaa !2, !alias.scope !11, !noalias !14
; CHECK-NEXT:   %1 = fadd fast double %0, %differeturn
; CHECK-NEXT:   store double %1, double* %"x'", align 8, !tbaa !2, !alias.scope !11, !noalias !14
; CHECK-NEXT:   ret void
; CHECK-NEXT: }
