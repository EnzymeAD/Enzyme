...
define void @foo(ptr %p, ptr "enzyme_type"="{[-1]:Pointer, [-1,0]:Pointer, [-1,8]:Integer, [-1,16]:Integer, [-1,24]:Integer, [-1,32]:Integer}" %out) {
entry:
...
; CHECK: entry:
; CHECK:   %"val'ipiv" = insertvalue %struct.SubArray { ptr null, [1 x [2 x i64]] {{.*}}i64 1, i64 2{{.*}}, i64 0, i64 1 }, ptr %"p'", 0
