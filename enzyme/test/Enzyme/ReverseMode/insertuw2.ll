...
; CHECK-NEXT: entry:
; CHECK-NEXT:   %"x1'de" = alloca { double, double, double* }, align 8
; CHECK-NEXT:   store { double, double, double* } zeroinitializer, { double, double, double* }* %"x1'de", align 8
; CHECK-NEXT:   %"out2'de" = alloca { double, double, double* }, align 8
; CHECK-NEXT:   store { double, double, double* } zeroinitializer, { double, double, double* }* %"out2'de", align 8
; CHECK-NEXT:   %"out1'de" = alloca { double, double, double* }, align 8
; CHECK-NEXT:   store { double, double, double* } zeroinitializer, { double, double, double* }* %"out1'de", align 8
; CHECK-NEXT:   %"x0'de" = alloca { double, double, double* }, align 8
; CHECK-NEXT:   store { double, double, double* } zeroinitializer, { double, double, double* }* %"x0'de", align 8
; CHECK-NEXT:   br i1 %c, label %trueb, label %exit

; CHECK: trueb:                                            ; preds = %entry
; CHECK-NEXT:   %pre_x0 = load double, double* %in0, align 8
; CHECK-NEXT:   store double 0.000000e+00, double* %in0, align 8
; CHECK-NEXT:   %x0 = insertvalue { double, double, double* } undef, double %pre_x0, 0
; CHECK-NEXT:   %pre_x1 = load double, double* %in1, align 8
; CHECK-NEXT:   store double 0.000000e+00, double* %in1, align 8
...
; CHECK-NEXT:   store double %mul0, double* %in0, align 8
...
; CHECK-NEXT:   %0 = load double, double* %"in0'", align 8
; CHECK-NEXT:   store double 0.000000e+00, double* %"in0'", align 8
...
; CHECK-NEXT:   %10 = load { double, double, double* }, { double, double, double* }* %"out2'de", align 8
; CHECK-NEXT:   %11 = insertvalue { double, double, double* } %10, double 0.000000e+00, 1
; CHECK-NEXT:   %12 = load { double, double, double* }, { double, double, double* }* %"out1'de", align 8
...
; CHECK-NEXT:   %15 = load double, double* %14, align 8
...
; CHECK-NEXT:   store { double, double, double* } zeroinitializer, { double, double, double* }* %"out2'de", align 8
; CHECK-NEXT:   %20 = load { double, double, double* }, { double, double, double* }* %"out1'de", align 8
; CHECK-NEXT:   %21 = insertvalue { double, double, double* } %20, double* null, 2
; CHECK-NEXT:   %22 = load { double, double, double* }, { double, double, double* }* %"x1'de", align 8
...
; CHECK-NEXT:   %25 = load double, double* %24, align 8
; CHECK-NEXT:   %26 = fadd fast double %25, %23
; CHECK-NEXT:   store double %26, double* %24, align 8
...
; CHECK-NEXT:   store double %30, double* %28, align 8
; CHECK-NEXT:   store { double, double, double* } zeroinitializer, { double, double, double* }* %"out1'de", align 8
; CHECK-NEXT:   %31 = load { double, double, double* }, { double, double, double* }* %"x1'de", align 8
; CHECK-NEXT:   %32 = extractvalue { double, double, double* } %31, 1
; CHECK-NEXT:   %33 = fadd fast double 0.000000e+00, %32
; CHECK-NEXT:   %34 = load { double, double, double* }, { double, double, double* }* %"x1'de", align 8
; CHECK-NEXT:   %35 = insertvalue { double, double, double* } %34, double 0.000000e+00, 1
; CHECK-NEXT:   %36 = load { double, double, double* }, { double, double, double* }* %"x0'de", align 8
...
; CHECK-NEXT:   %39 = load double, double* %38, align 8
; CHECK-NEXT:   %40 = fadd fast double %39, %37
; CHECK-NEXT:   store double %40, double* %38, align 8
; CHECK-NEXT:   %41 = getelementptr inbounds { double, double, double* }, { double, double, double* }* %"x0'de", i32 0, i32 1
; CHECK-NEXT:   %42 = load double, double* %41, align 8
; CHECK-NEXT:   %43 = fadd fast double %42, 0.000000e+00
; CHECK-NEXT:   store double %43, double* %41, align 8
; CHECK-NEXT:   store { double, double, double* } zeroinitializer, { double, double, double* }* %"x1'de", align 8
; CHECK-NEXT:   store double 0.000000e+00, double* %"in1'", align 8
; CHECK-NEXT:   %44 = load double, double* %"in1'", align 8
; CHECK-NEXT:   %45 = fadd fast double %44, %33
; CHECK-NEXT:   store double %45, double* %"in1'", align 8
; CHECK-NEXT:   %46 = load { double, double, double* }, { double, double, double* }* %"x0'de", align 8
; CHECK-NEXT:   %47 = extractvalue { double, double, double* } %46, 0
; CHECK-NEXT:   %48 = fadd fast double 0.000000e+00, %47
; CHECK-NEXT:   store { double, double, double* } zeroinitializer, { double, double, double* }* %"x0'de", align 8
; CHECK-NEXT:   store double 0.000000e+00, double* %"in0'", align 8
; CHECK-NEXT:   %49 = load double, double* %"in0'", align 8
; CHECK-NEXT:   %50 = fadd fast double %49, %48
; CHECK-NEXT:   store double %50, double* %"in0'", align 8
