...
; RUN: if [ %llvmver -ge 12 ]; then %opt < %s %newLoadEnzyme -passes="enzyme,mem2reg,gvn,adce,instsimplify,early-cse-memssa,simplifycfg"  -enzyme-preopt=false -S | FileCheck %s; fi
