...
; CHECK-NEXT:   call void @free(i8* nonnull %[[phiptr]])
...
; CHECK-NEXT:   %[[m0diffeloadi1:.+]] = fmul fast double %[[m0diffe]], 0xBFF3333333333332
; CHECK-NEXT:   %[[a14:.+]] = fadd fast double %"add10.i.i.i'de.0", %[[m0diffeloadi1]]
