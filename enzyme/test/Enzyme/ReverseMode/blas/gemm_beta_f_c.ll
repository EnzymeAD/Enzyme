...
define void @f(i8* %C, i8* %A, i8* %B, i8* %beta) {
entry:
...
; CHECK:   %mul.i8 = add nuw nsw i64 %[[i27]], %[[i28]]
...
; CHECK-NEXT:   %34 = mul nuw nsw i64 %j.i9, %[[i27]]
...
; CHECK-NEXT:   %38 = icmp eq i64 %i.next.i15, %[[i27]]
...
; CHECK-NEXT:   %39 = icmp eq i64 %j.next.i17, %[[i28]]
