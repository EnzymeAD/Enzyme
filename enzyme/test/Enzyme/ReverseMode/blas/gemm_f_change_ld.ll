...
; CHECK-NEXT:   %loaded.trans = load i8, i8* %transb, align 1
...
; CHECK-NEXT:   store i8 %18, i8* %byref.transpose.transa, align 1
...
; CHECK-NEXT:   store i8 %26, i8* %byref.transpose.transb, align 1
