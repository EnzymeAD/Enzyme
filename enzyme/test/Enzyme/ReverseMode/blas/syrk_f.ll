...
; CHECK-NEXT:   %[[i18:.+]] = load i8, i8* %uplo, align 1
; CHECK-NEXT:   %[[i19:.+]] = icmp eq i8 %[[i18]], 101
; CHECK-NEXT:   %[[i20:.+]] = select i1 %[[i19]], i64 %[[i17]], i64 1
; CHECK-NEXT:   %[[i21:.+]] = bitcast i8* %intcast.for.i to i64*
; CHECK-NEXT:   %[[i22:.+]] = load i64, i64* %[[i21]], align 4
; CHECK-NEXT:   %[[i23:.+]] = mul i64 %[[i22]], %[[i20]]
; CHECK-NEXT:   %[[i24:.+]] = select i1 %[[i19]], i64 1, i64 %[[i17]]
; CHECK-NEXT:   %[[i25:.+]] = bitcast i8* %intcast.for.i to i64*
; CHECK-NEXT:   %[[i26:.+]] = load i64, i64* %[[i25]], align 4
; CHECK-NEXT:   %[[i27:.+]] = mul i64 %[[i26]], %[[i24]]
...
; CHECK-NEXT:   %[[i45:.+]] = load i8, i8* %uplo, align 1
; CHECK-NEXT:   %[[i46:.+]] = icmp eq i8 %[[i45]], 101
; CHECK-NEXT:   %[[i47:.+]] = select i1 %[[i46]], i64 %[[i44]], i64 1
; CHECK-NEXT:   %[[i48:.+]] = bitcast i8* %[[i37]] to i64*
; CHECK-NEXT:   %[[i49:.+]] = load i64, i64* %[[i48]], align 4
; CHECK-NEXT:   %[[i50:.+]] = mul i64 %[[i49]], %[[i47]]
; CHECK-NEXT:   %[[i51:.+]] = select i1 %[[i46]], i64 1, i64 %[[i44]]
; CHECK-NEXT:   %[[i52:.+]] = bitcast i8* %[[i41]] to i64*
; CHECK-NEXT:   %[[i53:.+]] = load i64, i64* %[[i52]], align 4
; CHECK-NEXT:   %[[i54:.+]] = mul i64 %[[i53]], %[[i51]]
...
; CHECK-NEXT:   %[[i72:.+]] = load i8, i8* %uplo, align 1
; CHECK-NEXT:   %[[i73:.+]] = icmp eq i8 %[[i72]], 101
; CHECK-NEXT:   %[[i74:.+]] = select i1 %[[i73]], i64 %[[i71]], i64 1
; CHECK-NEXT:   %[[i75:.+]] = bitcast i8* %[[i64]] to i64*
; CHECK-NEXT:   %[[i76:.+]] = load i64, i64* %[[i75]], align 4
; CHECK-NEXT:   %[[i77:.+]] = mul i64 %[[i76]], %[[i74]]
; CHECK-NEXT:   %[[i78:.+]] = select i1 %[[i73]], i64 1, i64 %[[i71]]
; CHECK-NEXT:   %[[i79:.+]] = bitcast i8* %[[i68]] to i64*
; CHECK-NEXT:   %[[i80:.+]] = load i64, i64* %[[i79]], align 4
; CHECK-NEXT:   %[[i81:.+]] = mul i64 %[[i80]], %[[i78]]
