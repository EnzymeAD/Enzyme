...
; CHECK-NEXT:   %1 = load i8, i8* %uplo, align 1
; CHECK-NEXT:   %2 = load i64, i64* %m, align 8
; CHECK-NEXT:   %3 = load i64, i64* %n, align 8
; CHECK-NEXT:   %4 = load i64, i64* %ldb, align 8
; CHECK-NEXT:   %5 = load i64, i64* %lda, align 8
; CHECK-NEXT:   call void @llvm.experimental.noalias.scope.decl
; CHECK-NEXT:   call void @llvm.experimental.noalias.scope.decl
; CHECK-NEXT:   %mul.i = add nuw nsw i64 %2, %3
; CHECK-NEXT:   %6 = icmp eq i64 %mul.i, 0
; CHECK-NEXT:   br i1 %6, label %__enzyme_dmemcpy_double_mat_64.exit, label %swtch.i

; CHECK: swtch.i:                                          ; preds = %invertentry
; CHECK-NEXT:   switch i8 %1, label %Ginit.idx.i [
...
; CHECK-NEXT:   %7 = mul nuw nsw i64 %Gj.i, %5
; CHECK-NEXT:   %8 = add nuw nsw i64 %Gi.i, %7
; CHECK-NEXT:   %Gdst.i.i = getelementptr inbounds double, double* %"a'", i64 %8
; CHECK-NEXT:   %9 = mul nuw nsw i64 %Gj.i, %4
; CHECK-NEXT:   %10 = add nuw nsw i64 %Gi.i, %9
; CHECK-NEXT:   %Gdst.i1.i = getelementptr inbounds double, double* %"b'", i64 %10
; CHECK-NEXT:   %Gsrc.i.l.i = load double, double* %Gdst.i.i, align 8, !alias.scope !3, !noalias !0
; CHECK-NEXT:   %Gdst.i.l.i = load double, double* %Gdst.i1.i, align 8, !alias.scope !0, !noalias !3
; CHECK-NEXT:   %11 = fadd double %Gsrc.i.l.i, %Gdst.i.l.i
; CHECK-NEXT:   store double %11, double* %Gdst.i1.i, align 8, !alias.scope !0, !noalias !3
; CHECK-NEXT:   %Gi.next.i = add nuw nsw i64 %Gi.i, 1
; CHECK-NEXT:   %12 = icmp eq i64 %Gi.next.i, %2
; CHECK-NEXT:   br i1 %12, label %Ginit.end.i, label %Gfor.body.i

; CHECK: Ginit.end.i:                                      ; preds = %Gfor.body.i
; CHECK-NEXT:   %Gj.next.i = add nuw nsw i64 %Gj.i, 1
; CHECK-NEXT:   %13 = icmp eq i64 %Gj.next.i, %3
; CHECK-NEXT:   br i1 %13, label %__enzyme_dmemcpy_double_mat_64.exit, label %Ginit.idx.i

; CHECK: Ufor.body.i:                                      ; preds = %Ufor.body.i, %Uinit.idx.i
; CHECK-NEXT:   %Ui.i = phi i64 [ 0, %Uinit.idx.i ], [ %Ui.next.i, %Ufor.body.i ]
; CHECK-NEXT:   %14 = mul nuw nsw i64 %Uj.i, %5
; CHECK-NEXT:   %15 = add nuw nsw i64 %Ui.i, %14
; CHECK-NEXT:   %Udst.i.i = getelementptr inbounds double, double* %"a'", i64 %15
; CHECK-NEXT:   %16 = mul nuw nsw i64 %Uj.i, %4
; CHECK-NEXT:   %17 = add nuw nsw i64 %Ui.i, %16
; CHECK-NEXT:   %Udst.i2.i = getelementptr inbounds double, double* %"b'", i64 %17
; CHECK-NEXT:   %Usrc.i.l.i = load double, double* %Udst.i.i, align 8, !alias.scope !3, !noalias !0
; CHECK-NEXT:   %Udst.i.l.i = load double, double* %Udst.i2.i, align 8, !alias.scope !0, !noalias !3
; CHECK-NEXT:   %18 = fadd double %Usrc.i.l.i, %Udst.i.l.i
; CHECK-NEXT:   store double %18, double* %Udst.i2.i, align 8, !alias.scope !0, !noalias !3
; CHECK-NEXT:   %Ui.next.i = add nuw nsw i64 %Ui.i, 1
; CHECK-NEXT:   %19 = icmp ult i64 %Uj.i, %2
; CHECK-NEXT:   %20 = select i1 %19, i64 %Uj.i, i64 %2
; CHECK-NEXT:   %21 = icmp eq i64 %Ui.next.i, %20
; CHECK-NEXT:   br i1 %21, label %Uinit.end.i, label %Ufor.body.i

; CHECK: Uinit.end.i:                                      ; preds = %Ufor.body.i
; CHECK-NEXT:   %Uj.next.i = add nuw nsw i64 %Uj.i, 1
; CHECK-NEXT:   %22 = icmp eq i64 %Uj.next.i, %3
; CHECK-NEXT:   br i1 %22, label %__enzyme_dmemcpy_double_mat_64.exit, label %Uinit.idx.i

; CHECK: Lfor.body.i:                                      ; preds = %Lfor.body.i, %Linit.idx.i
; CHECK-NEXT:   %Li.i = phi i64 [ %Lj.i, %Linit.idx.i ], [ %Li.next.i, %Lfor.body.i ]
; CHECK-NEXT:   %23 = mul nuw nsw i64 %Lj.i, %5
; CHECK-NEXT:   %24 = add nuw nsw i64 %Li.i, %23
; CHECK-NEXT:   %Ldst.i.i = getelementptr inbounds double, double* %"a'", i64 %24
; CHECK-NEXT:   %25 = mul nuw nsw i64 %Lj.i, %4
; CHECK-NEXT:   %26 = add nuw nsw i64 %Li.i, %25
; CHECK-NEXT:   %Ldst.i3.i = getelementptr inbounds double, double* %"b'", i64 %26
; CHECK-NEXT:   %Lsrc.i.l.i = load double, double* %Ldst.i.i, align 8, !alias.scope !3, !noalias !0
; CHECK-NEXT:   %Ldst.i.l.i = load double, double* %Ldst.i3.i, align 8, !alias.scope !0, !noalias !3
; CHECK-NEXT:   %27 = fadd double %Lsrc.i.l.i, %Ldst.i.l.i
; CHECK-NEXT:   store double %27, double* %Ldst.i3.i, align 8, !alias.scope !0, !noalias !3
; CHECK-NEXT:   %Li.next.i = add nuw nsw i64 %Li.i, 1
; CHECK-NEXT:   %28 = icmp eq i64 %Li.next.i, %2
; CHECK-NEXT:   br i1 %28, label %Linit.end.i, label %Lfor.body.i

; CHECK: Linit.end.i:                                      ; preds = %Lfor.body.i
; CHECK-NEXT:   %Lj.next.i = add nuw nsw i64 %Lj.i, 1
; CHECK-NEXT:   %29 = icmp eq i64 %Lj.next.i, %3
; CHECK-NEXT:   br i1 %29, label %__enzyme_dmemcpy_double_mat_64.exit, label %Linit.idx.i

; CHECK: __enzyme_dmemcpy_double_mat_64.exit:              ; preds = %invertentry, %Ginit.end.i, %Uinit.end.i, %Linit.end.i
