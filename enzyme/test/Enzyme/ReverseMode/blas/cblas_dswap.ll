...
define void @f(i32 %n, double* noalias %x, double* noalias %y) {
entry:
...
entry:
  ...
  call void @__enzyme_autodiff(i8* bitcast (void (i32, double*, double*)* @f to i8*), i32 3, double* nonnull %arraydecay, double* nonnull %arraydecay1, double* nonnull %arraydecay2, double* nonnull %arraydecay3)
...
;CHECK:define internal void @diffef(i32 %n, double* noalias %x, double* %"x'", double* noalias %y, double* %"y'") {
;CHECK-NEXT:entry:
