...
; CHECK-NEXT:   %byref.constant.int.030 = alloca i64, align 8
; CHECK-NEXT:   %byref.constant.fp.1.0 = alloca double, align 8
; CHECK-NEXT:   %byref.constant.int.031 = alloca i64, align 8
...
; CHECK-NEXT:   %A = call i8* @AData(i64 %iv) #6
; CHECK-NEXT:   %lda_p = call i8* @Aldap(i64 %iv) #6
; CHECK-NEXT:   %avld.transa = load i8, i8* %transa, align 1, !invariant.group !7
; CHECK-NEXT:   %avld.transb = load i8, i8* %transb, align 1, !invariant.group !8
; CHECK-NEXT:   %pcld.k = bitcast i8* %k_p to i64*
; CHECK-NEXT:   %avld.k = load i64, i64* %pcld.k, align 4, !invariant.group !9
; CHECK-NEXT:   %pcld.alpha = bitcast i8* %alpha_p to double*
; CHECK-NEXT:   %avld.alpha = load double, double* %pcld.alpha, align 8, !invariant.group !10
; CHECK-NEXT:   %pcld.lda = bitcast i8* %lda_p to i64*
; CHECK-NEXT:   %avld.lda = load i64, i64* %pcld.lda, align 4, !invariant.group !11
; CHECK-NEXT:   %pcld.ldb = bitcast i8* %ldb_p to i64*
; CHECK-NEXT:   %avld.ldb = load i64, i64* %pcld.ldb, align 4, !invariant.group !12
; CHECK-NEXT:   %pcld.beta = bitcast i8* %beta_p to double*
; CHECK-NEXT:   %avld.beta = load double, double* %pcld.beta, align 8, !invariant.group !13
; CHECK-NEXT:   %pcld.ldc = bitcast i8* %ldc_p to i64*
; CHECK-NEXT:   %avld.ldc = load i64, i64* %pcld.ldc, align 4, !invariant.group !14
...
; CHECK-NEXT:   %10 = load i64, i64* %9, align 4
...
; CHECK-NEXT:   %src.i.l.i = load double, double* %dst.i1.i, align 8, !alias.scope !21, !noalias !18
; CHECK-NEXT:   store double %src.i.l.i, double* %dst.i.i, align 8, !alias.scope !18, !noalias !21
...
; CHECK-NEXT:   %28 = load i64, i64* %"iv'ac", align 4
...
; CHECK-NEXT:   %30 = load i64, i64* %"iv'ac", align 4
...
; CHECK-NEXT:   %32 = load i64, i64* %"iv'ac", align 4
...
; CHECK-NEXT:   %avld.ldc_unwrap = load i64, i64* %pcld.ldc_unwrap, align 4, !invariant.group !14
; CHECK-NEXT:   %pcld.beta_unwrap = bitcast i8* %beta_p to double*
; CHECK-NEXT:   %avld.beta_unwrap = load double, double* %pcld.beta_unwrap, align 8, !invariant.group !13
; CHECK-NEXT:   %pcld.ldb_unwrap = bitcast i8* %ldb_p to i64*
; CHECK-NEXT:   %avld.ldb_unwrap = load i64, i64* %pcld.ldb_unwrap, align 4, !invariant.group !12
...
; CHECK-NEXT:   %avld.lda_unwrap = load i64, i64* %pcld.lda_unwrap, align 4, !invariant.group !11
; CHECK-NEXT:   %pcld.alpha_unwrap = bitcast i8* %alpha_p to double*
; CHECK-NEXT:   %avld.alpha_unwrap = load double, double* %pcld.alpha_unwrap, align 8, !invariant.group !10
; CHECK-NEXT:   %pcld.k_unwrap = bitcast i8* %k_p to i64*
; CHECK-NEXT:   %avld.k_unwrap = load i64, i64* %pcld.k_unwrap, align 4, !invariant.group !9
; CHECK-NEXT:   %avld.transb_unwrap = load i8, i8* %transb, align 1, !invariant.group !8
; CHECK-NEXT:   %avld.transa_unwrap = load i8, i8* %transa, align 1, !invariant.group !7
...
; CHECK-NEXT:   %40 = load i64, i64* %"iv'ac", align 4
; CHECK-NEXT:   %41 = load i8*, i8** %m_p_cache, align 8, !invariant.group !6
; CHECK-NEXT:   %42 = load i64, i64* %"iv'ac", align 4
...
; CHECK-NEXT:   store i8 %50, i8* %byref.transpose.transa, align 1
...
; CHECK-NEXT:   store i8 %58, i8* %byref.transpose.transb, align 1
; CHECK-NEXT:   call void @dgemm_64_(i8* %byref.transpose.transa, i8* %byref.transb, i8* %cast.k, i8* %n_p_unwrap, i8* %41, i8* %cast.alpha, i8* %39, i8* %cast.lda, i8* %"C'", i8* %cast.ldc, i8* %cast.beta, i8* %"B'", i8* %cast.ldb)
; CHECK-NEXT:   store i8 71, i8* %byref.constant.char.G, align 1
; CHECK-NEXT:   store i64 0, i64* %byref.constant.int.0, align 4
; CHECK-NEXT:   store i64 0, i64* %byref.constant.int.030, align 4
; CHECK-NEXT:   store double 1.000000e+00, double* %byref.constant.fp.1.0, align 8
; CHECK-NEXT:   store i64 0, i64* %byref.constant.int.031, align 4
...
; CHECK-NEXT:   %59 = bitcast double* %tape.ext.A to i8*
; CHECK-NEXT:   tail call void @free(i8* nonnull %59)
; CHECK-NEXT:   call void @free(i8* %41)
; CHECK-NEXT:   %60 = load i64, i64* %"iv'ac", align 4
; CHECK-NEXT:   %61 = icmp eq i64 %60, 0
; CHECK-NEXT:   %62 = xor i1 %61, true
; CHECK-NEXT:   br i1 %61, label %invertentry, label %incinvertloop

; CHECK: incinvertloop:                                    ; preds = %invertloop
; CHECK-NEXT:   %63 = load i64, i64* %"iv'ac", align 4
; CHECK-NEXT:   %64 = add nsw i64 %63, -1
; CHECK-NEXT:   store i64 %64, i64* %"iv'ac", align 4
...
; CHECK-NEXT:   store i64 9, i64* %"iv'ac", align 4
; CHECK-NEXT:   br label %remat_enter
...
; CHECK-NEXT:   %65 = load i64, i64* %"iv'ac", align 4
; CHECK-NEXT:   %66 = load i8*, i8** %m_p_cache, align 8, !invariant.group !6
; CHECK-NEXT:   %m_unwrap = bitcast i8* %66 to i64*
; CHECK-NEXT:   store i64 4, i64* %m_unwrap, align 16
; CHECK-NEXT:   %67 = load i64, i64* %"iv'ac", align 4
; CHECK-NEXT:   %iv.next_unwrap = add nuw nsw i64 %67, 1
...
; CHECK-NEXT:   %src.i.l = load double, double* %dst.i1, align 8
; CHECK-NEXT:   store double %src.i.l, double* %dst.i, align 8
