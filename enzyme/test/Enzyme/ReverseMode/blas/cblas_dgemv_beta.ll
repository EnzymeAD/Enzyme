...
define void @f(double* noalias %x, double* noalias %y, double* noalias %a, double %beta) {
entry:
  tail call void @cblas_dgemv(i32 102, i32 111, i32 2, i32 2, double 3.000000e+00, double* %a, i32 2, double* %x, i32 1, double %beta, double* %y, i32 1)
  ret void
}
...
entry:
  ...
  %call = call double @__enzyme_autodiff(i8* bitcast (void (double*, double*, double*, double)* @f to i8*), double* nonnull %arraydecay, double* nonnull %arraydecay1, double* nonnull %arraydecay2, double* nonnull %arraydecay3, double* nonnull %arraydecay4, double* nonnull %arraydecay5, double 2.000000e+00)
...
;CHECK:define internal { double } @diffef(double* noalias %x, double* %"x'", double* noalias %y, double* %"y'", double* noalias %a, double* %"a'", double %beta) {
;CHECK-NEXT:entry:
;CHECK-NEXT:  tail call void @cblas_dgemv(i32 102, i32 111, i32 2, i32 2, double 3.000000e+00, double* %a, i32 2, double* %x, i32 1, double %beta, double* %y, i32 1)
