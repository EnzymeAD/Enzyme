...
define void @f(double* noalias %x, double* noalias %y, double* noalias %a) {
entry:
  tail call void @cblas_dgemv(i32 102, i32 111, i32 2, i32 2, double 3.000000e+00, double* %a, i32 2, double* %x, i32 1, double 2.000000e+00, double* %y, i32 1)
  ret void
}
...
entry:
  ...
  call void @__enzyme_autodiff(i8* bitcast (void (double*, double*, double*)* @f to i8*), double* nonnull %arraydecay, double* nonnull %arraydecay1, double* nonnull %arraydecay2, double* nonnull %arraydecay3, double* nonnull %arraydecay4, double* nonnull %arraydecay5)
...
declare void @__enzyme_autodiff(i8*, double*, double*, double*, double*, double*, double*)
;CHECK:define internal void @diffef(double* noalias %x, double* %"x'", double* noalias %y, double* %"y'", double* noalias %a, double* %"a'") {
;CHECK-NEXT:entry:
;CHECK-NEXT:  tail call void @cblas_dgemv(i32 102, i32 111, i32 2, i32 2, double 3.000000e+00, double* %a, i32 2, double* %x, i32 1, double 2.000000e+00, double* %y, i32 1)
