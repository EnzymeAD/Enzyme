...
; CHECK-NEXT:   %byref.constant.int.16 = alloca i64, align 8
; CHECK-NEXT:   %byref.constant.fp.1.08 = alloca double, align 8
...
; CHECK-NEXT:   %1 = load i64, i64* %0, align 4
...
; CHECK-NEXT:   %3 = load i64, i64* %2, align 4
...
; CHECK-NEXT:   store i64 1, i64* %byref.constant.int.16, align 4
...
; CHECK-NEXT:   %15 = load double, double* %14, align 8, !alias.scope !5, !noalias !8
; CHECK-NEXT:   %16 = fadd fast double %15, %13
; CHECK-NEXT:   store double %16, double* %14, align 8, !alias.scope !5, !noalias !8
; CHECK-NEXT:   call void @dspr2_64_(i8* %uplo, i8* %n_p, i8* %alpha, i8* %X, i8* %incx_p, i8* %"Y'", i8* %incy_p, i8* %"AP'")
; CHECK-NEXT:   call void @llvm.experimental.noalias.scope.decl(metadata !10)
; CHECK-NEXT:   call void @llvm.experimental.noalias.scope.decl(metadata !13)
; CHECK-NEXT:   call void @llvm.experimental.noalias.scope.decl(metadata !15)
; CHECK-NEXT:   %17 = load i64, i64* %n, align 4, !noalias !17
; CHECK-NEXT:   %18 = load i64, i64* %incx, align 4, !noalias !17
; CHECK-NEXT:   %19 = bitcast i8* %"Y'" to i64*
; CHECK-NEXT:   %20 = load i64, i64* %19, align 4, !alias.scope !15, !noalias !18
; CHECK-NEXT:   %21 = bitcast i8* %alpha to double*
; CHECK-NEXT:   %22 = load double, double* %21, align 8, !alias.scope !10, !noalias !19
; CHECK-NEXT:   %loaded.trans.i = load i8, i8* %uplo, align 1, !noalias !17
...
; CHECK-NEXT:   %x.val.i = load double, double* %x.ptr.i, align 8, !alias.scope !13, !noalias !20
; CHECK-NEXT:   %y.val.i = load double, double* %y.ptr.i, align 8, !noalias !17
...
; CHECK-NEXT:   %k.val.i = load double, double* %k.ptr.i, align 8, !noalias !17
; CHECK-NEXT:   %k.val.new.i = fsub fast double %k.val.i, %xy.alpha.i
; CHECK-NEXT:   store double %k.val.new.i, double* %k.ptr.i, align 8, !noalias !17
...
; CHECK-NEXT:   %x.val10.i = load double, double* %x.ptr8.i, align 8, !alias.scope !13, !noalias !20
; CHECK-NEXT:   %y.val11.i = load double, double* %y.ptr9.i, align 8, !noalias !17
...
; CHECK-NEXT:   %k.val15.i = load double, double* %k.ptr14.i, align 8, !noalias !17
; CHECK-NEXT:   %k.val.new16.i = fsub fast double %k.val15.i, %xy.alpha13.i
; CHECK-NEXT:   store double %k.val.new16.i, double* %k.ptr14.i, align 8, !noalias !17
...
; CHECK-NEXT:   store double 1.000000e+00, double* %byref.constant.fp.1.08, align 8
...
; CHECK-NEXT:   %34 = load double, double* %33, align 8, !alias.scope !21, !noalias !24
; CHECK-NEXT:   %35 = fadd fast double %34, %32
; CHECK-NEXT:   store double %35, double* %33, align 8, !alias.scope !21, !noalias !24
...
; CHECK-NEXT:   %2 = load i64, i64* %1, align 4
...
; CHECK-NEXT:   %loaded.trans = load i8, i8* %blasuplo, align 1
...
; CHECK-NEXT:   %x.val = load double, double* %x.ptr, align 8
; CHECK-NEXT:   %y.val = load double, double* %y.ptr, align 8
...
; CHECK-NEXT:   %k.val = load double, double* %k.ptr, align 8
; CHECK-NEXT:   %k.val.new = fsub fast double %k.val, %xy.alpha
; CHECK-NEXT:   store double %k.val.new, double* %k.ptr, align 8
...
; CHECK-NEXT:   %x.val10 = load double, double* %x.ptr8, align 8
; CHECK-NEXT:   %y.val11 = load double, double* %y.ptr9, align 8
...
; CHECK-NEXT:   %k.val15 = load double, double* %k.ptr14, align 8
; CHECK-NEXT:   %k.val.new16 = fsub fast double %k.val15, %xy.alpha13
; CHECK-NEXT:   store double %k.val.new16, double* %k.ptr14, align 8
