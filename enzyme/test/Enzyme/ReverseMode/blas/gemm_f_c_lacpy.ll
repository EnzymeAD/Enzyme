...
; CHECK-DAG:   %[[r18:.+]] = icmp eq i8 %loaded.trans5, 78
; CHECK-DAG:   %[[r19:.+]] = icmp eq i8 %loaded.trans5, 110
...
; CHECK-DAG:   %[[r22:.+]] = icmp eq i8 %loaded.trans6, 78
; CHECK-DAG:   %[[r23:.+]] = icmp eq i8 %loaded.trans6, 110
