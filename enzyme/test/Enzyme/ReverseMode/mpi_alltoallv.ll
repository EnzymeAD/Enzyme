...
; CHECK-NEXT:   store i64 0, i64* %5, align 4
...
; CHECK-NEXT:   %10 = load i64, i64* %5, align 4
; CHECK-NEXT:   %11 = add i64 %10, %9
; CHECK-NEXT:   store i64 %11, i64* %5, align 4
...
; CHECK-NEXT:   %14 = load i64, i64* %5, align 4
; CHECK-NEXT:   %15 = mul i64 %14, 4
; CHECK-NEXT:   store i64 %15, i64* %5, align 4
; CHECK-NEXT:   %16 = load i64, i64* %5, align 4
...
; CHECK-NEXT:   %20 = load i32, i32* %2, align 4
; CHECK-NEXT:   %21 = alloca i64, align 8
; CHECK-NEXT:   store i64 0, i64* %21, align 4
...
; CHECK-NEXT:   %24 = load i32, i32* %23, align 4
; CHECK-NEXT:   %25 = zext i32 %24 to i64
; CHECK-NEXT:   %26 = load i64, i64* %21, align 4
; CHECK-NEXT:   %27 = add i64 %26, %25
; CHECK-NEXT:   store i64 %27, i64* %21, align 4
...
; CHECK-NEXT:   %30 = load i64, i64* %21, align 4
; CHECK-NEXT:   %31 = mul i64 %30, 4
; CHECK-NEXT:   store i64 %31, i64* %21, align 4
; CHECK-NEXT:   %32 = load i64, i64* %21, align 4
