...
entry:
  call void (i8*, ...) @__enzyme_autodiff(i8* noundef bitcast (void (float*, i32*, i32*, float*, i32*, i32*)* @mpi_alltoallv_test to i8*), float* noundef %sendbuf, float* noundef %dsendbuf, i32* noundef %sendcounts, i32* noundef %senddispls, float* noundef %recvbuf, float* noundef %drecvbuf, i32* noundef %recvcounts, i32* noundef %recvdispls)
...
; CHECK: define internal void @diffempi_alltoallv_test(float* noundef %0, float* %"'", i32* noundef %1, i32* noundef %2, float* noundef %3, float* %"'1", i32* noundef %4, i32* noundef %5) #0 {
; CHECK-NEXT: invert:
...
; CHECK-NEXT:   %10 = tail call i32 @MPI_Alltoallv(i8* noundef %8, i32* noundef %1, i32* noundef %2, %struct.ompi_datatype_t* noundef bitcast (%struct.ompi_predefined_datatype_t* @ompi_mpi_float to %struct.ompi_datatype_t*), i8* noundef %9, i32* noundef %4, i32* noundef %5, %struct.ompi_datatype_t* noundef bitcast (%struct.ompi_predefined_datatype_t* @ompi_mpi_float to %struct.ompi_datatype_t*), %struct.ompi_communicator_t* noundef bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_world to %struct.ompi_communicator_t*)) #0
