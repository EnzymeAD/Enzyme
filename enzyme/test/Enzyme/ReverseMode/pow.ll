...
; CHECK-NEXT:   %[[origpowdret:.+]] = fmul fast double %[[origpow]], %[[logy]]
; CHECK-NEXT:   %[[guardeddy:.+]] = select fast i1 %[[isxzero]], double 0.000000e+00, double %[[origpowdret]]
; CHECK-NEXT:   %[[dy:.+]] = fmul fast double %differeturn, %[[guardeddy]]
