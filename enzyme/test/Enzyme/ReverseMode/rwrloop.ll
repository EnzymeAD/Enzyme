...
; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,mem2reg,early-cse,simplifycfg,instsimplify,correlated-propagation,instsimplify,adce"  -enzyme-preopt=false -S | FileCheck %s
