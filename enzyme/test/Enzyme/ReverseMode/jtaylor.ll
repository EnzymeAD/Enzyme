...
; RUN: if [ %llvmver -ge 12 ]; then %opt < %s %newLoadEnzyme -passes="enzyme,mem2reg,adce,correlated-propagation,instsimplify,simplifycfg"  -enzyme-preopt=false -S | FileCheck %s; fi
