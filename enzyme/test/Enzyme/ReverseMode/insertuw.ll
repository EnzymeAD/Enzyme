...
; CHECK-NEXT:   %10 = load { double, double, double* }, { double, double, double* }* %"out1'de", align 8
; CHECK-NEXT:   %11 = insertvalue { double, double, double* } %10, double* null, 2
; CHECK-NEXT:   %12 = load { double, double, double* }, { double, double, double* }* %"x1'de", align 8
...
; CHECK-NEXT:   store { double, double, double* } zeroinitializer, { double, double, double* }* %"out1'de", align 8
; CHECK-NEXT:   %21 = load { double, double, double* }, { double, double, double* }* %"x1'de", align 8
; CHECK-NEXT:   %22 = extractvalue { double, double, double* } %21, 1
; CHECK-NEXT:   %23 = fadd fast double 0.000000e+00, %22
; CHECK-NEXT:   %24 = load { double, double, double* }, { double, double, double* }* %"x1'de", align 8
; CHECK-NEXT:   %25 = insertvalue { double, double, double* } %24, double 0.000000e+00, 1
; CHECK-NEXT:   %26 = load { double, double, double* }, { double, double, double* }* %"x0'de", align 8
...
; CHECK-NEXT:   store double %33, double* %31, align 8
; CHECK-NEXT:   store { double, double, double* } zeroinitializer, { double, double, double* }* %"x1'de", align 8
; CHECK-NEXT:   store double 0.000000e+00, double* %"in1'", align 8
; CHECK-NEXT:   %34 = load double, double* %"in1'", align 8
; CHECK-NEXT:   %35 = fadd fast double %34, %23
; CHECK-NEXT:   store double %35, double* %"in1'", align 8
...
; CHECK-NEXT:   store { double, double, double* } zeroinitializer, { double, double, double* }* %"x0'de", align 8
; CHECK-NEXT:   store double 0.000000e+00, double* %"in0'", align 8
; CHECK-NEXT:   %39 = load double, double* %"in0'", align 8
; CHECK-NEXT:   %40 = fadd fast double %39, %38
; CHECK-NEXT:   store double %40, double* %"in0'", align 8
