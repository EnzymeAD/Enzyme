...
; CHECK-NEXT:   %malloccall = extractvalue { i8*, i8*, i8* } %tapeArg, 1
; CHECK-NEXT:   %"malloccall'mi" = extractvalue { i8*, i8*, i8* } %tapeArg, 0
...
; CHECK-NEXT:   %2 = bitcast %struct.ompi_request_t** %"r2'ipc" to { i8*, i64, i8*, i64, i64, i8*, i8, i8* }**
; CHECK-NEXT:   %3 = load { i8*, i64, i8*, i64, i64, i8*, i8, i8* }*, { i8*, i64, i8*, i64, i64, i8*, i8, i8* }** %2
; CHECK-NEXT:   %4 = icmp eq { i8*, i64, i8*, i64, i64, i8*, i8, i8* }* %3, null
; CHECK-NEXT:   br i1 %4, label %invertentry_end, label %invertentry_nonnull

; CHECK: invertentry_nonnull:                              ; preds = %entry
; CHECK-NEXT:   %5 = load { i8*, i64, i8*, i64, i64, i8*, i8, i8* }, { i8*, i64, i8*, i64, i64, i8*, i8, i8* }* %3
; CHECK-NEXT:   %6 = extractvalue { i8*, i64, i8*, i64, i64, i8*, i8, i8* } %5, 0
; CHECK-NEXT:   %7 = extractvalue { i8*, i64, i8*, i64, i64, i8*, i8, i8* } %5, 1
; CHECK-NEXT:   %8 = extractvalue { i8*, i64, i8*, i64, i64, i8*, i8, i8* } %5, 2
; CHECK-NEXT:   %9 = extractvalue { i8*, i64, i8*, i64, i64, i8*, i8, i8* } %5, 3
; CHECK-NEXT:   %10 = extractvalue { i8*, i64, i8*, i64, i64, i8*, i8, i8* } %5, 4
; CHECK-NEXT:   %11 = extractvalue { i8*, i64, i8*, i64, i64, i8*, i8, i8* } %5, 5
; CHECK-NEXT:   %12 = extractvalue { i8*, i64, i8*, i64, i64, i8*, i8, i8* } %5, 6
; CHECK-NEXT:   call void @__enzyme_differential_mpi_wait(i8* %6, i64 %7, i8* %8, i64 %9, i64 %10, i8* %11, i8 %12, %struct.ompi_request_t** %r2) #5
; CHECK-NEXT:   br label %invertentry_end

; CHECK: invertentry_end:                                  ; preds = %invertentry_nonnull, %entry
; CHECK-NEXT:   %13 = bitcast %struct.ompi_request_t** %"r2'ipc" to { i8*, i64, i8*, i64, i64, i8*, i8, i8* }**
; CHECK-NEXT:   %14 = load { i8*, i64, i8*, i64, i64, i8*, i8, i8* }*, { i8*, i64, i8*, i64, i64, i8*, i8, i8* }** %13
; CHECK-NEXT:   %15 = getelementptr inbounds { i8*, i64, i8*, i64, i64, i8*, i8, i8* }, { i8*, i64, i8*, i64, i64, i8*, i8, i8* }* %14, i64 0, i32 0
; CHECK-NEXT:   %16 = load i8*, i8** %15
; CHECK-NEXT:   %17 = getelementptr inbounds { i8*, i64, i8*, i64, i64, i8*, i8, i8* }, { i8*, i64, i8*, i64, i64, i8*, i8, i8* }* %14, i64 0, i32 7
; CHECK-NEXT:   %18 = load i8*, i8** %17
; CHECK-NEXT:   %19 = bitcast %struct.ompi_request_t** %"r2'ipc" to i8**
; CHECK-NEXT:   store i8* %18, i8** %19
; CHECK-NEXT:   %20 = call i32 @MPI_Type_size(i8* bitcast (%struct.ompi_predefined_datatype_t* @ompi_mpi_real to i8*), i32* %0)
; CHECK-NEXT:   %21 = load i32, i32* %0
; CHECK-NEXT:   %22 = call i32 @MPI_Wait(%struct.ompi_request_t** %r2, %struct.ompi_status_public_t* %1)
; CHECK-NEXT:   %23 = zext i32 %21 to i64
; CHECK-NEXT:   call void @llvm.memset.p0i8.i64(i8* nonnull %16, i8 0, i64 %23, i1 false)
; CHECK-NEXT:   %24 = bitcast { i8*, i64, i8*, i64, i64, i8*, i8, i8* }* %14 to i8*
