; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,inline,mem2reg,sroa,simplifycfg,instcombine,adce"  -enzyme-preopt=false -S | FileCheck %s
...
; CHECK-NEXT:   %"B2p'ipg" = getelementptr inbounds double, double* %"B'", i64 1
; CHECK-NEXT:   %B2p = getelementptr inbounds double, double* %B, i64 1
; CHECK-NEXT:   %B2 = load double, double* %B2p, align 8
; CHECK-NEXT:   %malloccall.i = call noalias nonnull dereferenceable(16) dereferenceable_or_null(16) i8* @malloc(i64 16) #11, !enzyme_fromstack !10
; CHECK-NEXT:   %"malloccall'mi.i" = call noalias nonnull dereferenceable(16) dereferenceable_or_null(16) i8* @malloc(i64 16) #11
; CHECK-NEXT:   call void @llvm.memset.p0i8.i64(i8* nonnull align 1 dereferenceable(16) dereferenceable_or_null(16) %"malloccall'mi.i", i8 0, i64 16, i1 false) #11
; CHECK-NEXT:   %Bref.i = bitcast i8* %malloccall.i to <2 x double>*
; CHECK-NEXT:   %W34p.i = getelementptr inbounds <2 x double>, <2 x double>* %Wptr, i64 1
; CHECK-NEXT:   %W34.i = load <2 x double>, <2 x double>* %W34p.i, align 16
; CHECK-NEXT:   %preb1.i = insertelement <2 x double> undef, double %B1, i32 0
; CHECK-NEXT:   %B11.i = shufflevector <2 x double> %preb1.i, <2 x double> undef, <2 x i32> zeroinitializer
; CHECK-NEXT:   %preb2.i = insertelement <2 x double> undef, double %B2, i32 0
; CHECK-NEXT:   %B22.i = shufflevector <2 x double> %preb2.i, <2 x double> undef, <2 x i32> zeroinitializer
; CHECK-NEXT:   store <2 x double> %B11.i, <2 x double>* %Bref.i, align 16
; CHECK-NEXT:   %0 = load <2 x double>, <2 x double>* %Wptr, align 16
; CHECK-NEXT:   %mul.i.i.i = fmul <2 x double> %0, %B11.i
; CHECK-NEXT:   %mul.i = fmul <2 x double> %W34.i, %B22.i
; CHECK-NEXT:   %add.i = fadd <2 x double> %mul.i, %mul.i.i.i
; CHECK-NEXT:   store <2 x double> %add.i, <2 x double>* %outvec, align 16
; CHECK-NEXT:   %1 = load <2 x double>, <2 x double>* %"outvec'", align 16
; CHECK-NEXT:   store <2 x double> zeroinitializer, <2 x double>* %"outvec'", align 16
; CHECK-NEXT:   %"Bref'ipc.i3" = bitcast i8* %"malloccall'mi.i" to <2 x double>*
; CHECK-NEXT:   %Bref.i4 = bitcast i8* %malloccall.i to <2 x double>*
; CHECK-NEXT:   %"W34p'ipg.i" = getelementptr inbounds <2 x double>, <2 x double>* %"Wptr'", i64 1
; CHECK-NEXT:   %preb2.i6 = insertelement <2 x double> undef, double %B2, i32 0
; CHECK-NEXT:   %B22.i7 = shufflevector <2 x double> %preb2.i6, <2 x double> undef, <2 x i32> zeroinitializer
; CHECK-NEXT:   %m0diffeW34.i = fmul fast <2 x double> %1, %B22.i7
; CHECK-NEXT:   %m1diffeB22.i = fmul fast <2 x double> %1, %W34.i
; CHECK-NEXT:   %2 = load <2 x double>, <2 x double>* %Bref.i4, align 16
; CHECK-NEXT:   %m0diffe.i.i = fmul fast <2 x double> %1, %2
; CHECK-NEXT:   %m1diffe.i.i = fmul fast <2 x double> %1, %0
; CHECK-NEXT:   %3 = load <2 x double>, <2 x double>* %"Bref'ipc.i3", align 16
; CHECK-NEXT:   %4 = fadd fast <2 x double> %3, %m1diffe.i.i
; CHECK-NEXT:   store <2 x double> %4, <2 x double>* %"Bref'ipc.i3", align 16
; CHECK-NEXT:   %5 = load <2 x double>, <2 x double>* %"Wptr'", align 16
; CHECK-NEXT:   %6 = fadd fast <2 x double> %5, %m0diffe.i.i
; CHECK-NEXT:   store <2 x double> %6, <2 x double>* %"Wptr'", align 16
; CHECK-NEXT:   store <2 x double> zeroinitializer, <2 x double>* %"Bref'ipc.i3", align 16
; CHECK-NEXT:   %7 = extractelement <2 x double> %m1diffeB22.i, i32 1
; CHECK-NEXT:   %8 = extractelement <2 x double> %m1diffeB22.i, i32 0
; CHECK-NEXT:   %9 = fadd fast double %7, %8
; CHECK-NEXT:   %10 = extractelement <2 x double> %4, i32 1
; CHECK-NEXT:   %11 = extractelement <2 x double> %4, i32 0
; CHECK-NEXT:   %12 = fadd fast double %10, %11
; CHECK-NEXT:   %13 = load <2 x double>, <2 x double>* %"W34p'ipg.i", align 16
; CHECK-NEXT:   %14 = fadd fast <2 x double> %13, %m0diffeW34.i
; CHECK-NEXT:   store <2 x double> %14, <2 x double>* %"W34p'ipg.i", align 16
; CHECK-NEXT:   call void @free(i8* nonnull %"malloccall'mi.i") #11
; CHECK-NEXT:   call void @free(i8* %malloccall.i) #11
; CHECK-NEXT:   %15 = load double, double* %"B2p'ipg", align 8
; CHECK-NEXT:   %16 = fadd fast double %15, %9
; CHECK-NEXT:   store double %16, double* %"B2p'ipg", align 8
; CHECK-NEXT:   %17 = load double, double* %"B'", align 8
; CHECK-NEXT:   %18 = fadd fast double %17, %12
; CHECK-NEXT:   store double %18, double* %"B'", align 8
; CHECK-NEXT:   ret void
; CHECK-NEXT: }
