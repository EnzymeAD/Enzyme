...
; CHECK-NEXT:   %[[pow:.+]] = call fast double @llvm.pow.f64(double %x, double %[[fsub]])
; CHECK-NEXT:   %[[fmul:.+]] = fmul fast double %[[pow]], %conv_unwrap
; CHECK-NEXT:   %[[fmul2:.+]] = fmul fast double %d0diffepow, %[[fmul]] 
