...
; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,mem2reg,instsimplify,adce,loop-deletion,correlated-propagation,simplifycfg,early-cse,instcombine,jump-threading"  -enzyme-preopt=false -S | FileCheck %s
