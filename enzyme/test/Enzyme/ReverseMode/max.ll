...
; CHECK-NEXT:   %[[accx:.+]] = fadd double 0.000000e+00, %[[differet]]
; CHECK-NEXT:   %[[diffex:.+]] = select {{(fast )?}}i1 %[[cmp]], double %[[accx]], double 0.000000e+00
; CHECK-NEXT:   %[[accy:.+]] = fadd double 0.000000e+00, %[[differet]]
; CHECK-NEXT:   %[[diffey:.+]] = select {{(fast )?}}i1 %[[cmp]], double 0.000000e+00, double %[[accy]]
