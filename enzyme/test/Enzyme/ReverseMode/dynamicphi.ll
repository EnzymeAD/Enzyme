...
; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,inline,mem2reg,gvn,instsimplify,adce,loop-deletion,correlated-propagation,simplifycfg,licm,early-cse,simplifycfg,instsimplify"  -enzyme-preopt=false -S | FileCheck %s -check-prefixes LL14,CHECK
