...
; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,inline,mem2reg,correlated-propagation,adce,instcombine,instsimplify,early-cse-memssa,simplifycfg,correlated-propagation,adce,jump-threading,instsimplify,early-cse,simplifycfg"  -enzyme-preopt=false -S | FileCheck %s
