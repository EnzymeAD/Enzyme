...
; CHECK: define internal i64 @augmented_subfn(double* nocapture %place, double* nocapture %"place'", i64* nocapture readonly %m_rows)
; CHECK-NEXT: entry:
...
; CHECK: define internal void @diffesubfn(double* nocapture %place, double* nocapture %"place'", i64* nocapture readonly %m_rows, i64 %rows)
; CHECK-NEXT: entry:
