...
; CHECK-NEXT: entry:
; CHECK-NEXT:   call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !{{[0-9]+}}, metadata !DIExpression())
; CHECK-NEXT:   call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !{{[0-9]+}}, metadata !DIExpression())
; CHECK-NEXT:   call void @llvm.dbg.value(metadata double %x, metadata !{{[0-9]+}}, metadata !DIExpression())
; CHECK-NEXT:   call void @llvm.dbg.value(metadata %struct.Data* null, metadata !{{[0-9]+}}, metadata !DIExpression())
...
; CHECK-NEXT:   call void @llvm.dbg.value(metadata %struct.Data* {{(undef|poison)}}, metadata !{{[0-9]+}}, metadata !DIExpression())
; CHECK-NEXT:   %"res1'ipg" = getelementptr inbounds i8, i8* %"call'mi", i64 16
; CHECK-NEXT:   %"'ipc" = bitcast i8* %"res1'ipg" to double*
; CHECK-NEXT:   call void @llvm.dbg.value(metadata double %differeturn, metadata !{{[0-9]+}}, metadata !DIExpression())
; CHECK-NEXT:   call void @llvm.dbg.value(metadata double 0.000000e+00, metadata !{{[0-9]+}}, metadata !DIExpression())
...
; CHECK-NEXT:   %[[i3:.+]] = call { double } @diffefoo(double %x, %struct.Data* {{(undef|poison)}}, %struct.Data* %"'ipc2")
; CHECK-NEXT:   call void @llvm.dbg.value(metadata double {{(undef|poison)}}, metadata !{{[0-9]+}}, metadata !DIExpression())
