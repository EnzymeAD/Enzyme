...
; CHECK: define internal {{(dso_local )?}}{ double } @diffecall(double %x, double %differeturn) #1 !dbg !99
; CHECK-NEXT: entry:
; CHECK-NEXT:   %call = call noalias nonnull dereferenceable(24) dereferenceable_or_null(24) i8* @malloc(i64 24) #8, !dbg !110
; CHECK-NEXT:   %"call'mi" = call noalias nonnull dereferenceable(24) dereferenceable_or_null(24) i8* @malloc(i64 24) #8, !dbg !110
; CHECK-NEXT:   call void @llvm.memset.p0i8.i64(i8* nonnull dereferenceable(24) dereferenceable_or_null(24) %"call'mi", i8 0, i64 24, i1 false), !dbg !110
; CHECK-NEXT:   %"'ipc2" = bitcast i8* %"call'mi" to %struct.Data*, !dbg !110
; CHECK-NEXT:   %0 = bitcast i8* %call to %struct.Data*, !dbg !110
; CHECK-NEXT:   %"res1'ipg" = getelementptr inbounds i8, i8* %"call'mi", i64 16, !dbg !111
; CHECK-NEXT:   %"'ipc" = bitcast i8* %"res1'ipg" to double*, !dbg !111
...
; CHECK-NEXT:   %3 = call { double } @diffefoo(double %x, %struct.Data* %0, %struct.Data* %"'ipc2"), !dbg !112
; CHECK-NEXT:   tail call void @free(i8* nonnull %"call'mi"), !dbg !110
; CHECK-NEXT:   tail call void @free(i8* nonnull %call), !dbg !110
