...
; CHECK-NEXT:   %5 = select i1 %2, <2 x double> %4, <2 x double> %3
; CHECK-NEXT:   %6 = fadd <2 x double> %5, zeroinitializer
; CHECK-NEXT:   %7 = insertvalue { <2 x double> } undef, <2 x double> %6, 0
