...
; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,mem2reg,instsimplify,simplifycfg,early-cse,dce,correlated-propagation,instcombine,loop-deletion,simplifycfg"  -enzyme-preopt=false -S | FileCheck %s
...
; CHECK: define internal {{(dso_local )?}}{ double } @diffeffib(i32 %n
