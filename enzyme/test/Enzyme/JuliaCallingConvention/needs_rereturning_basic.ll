...
; CHECK-NEXT: entry:
; CHECK-NEXT:   [[GEP1:%[0-9]+]] = getelementptr inbounds {{.*}}, ptr %0, i32 0, i32 1
; CHECK-NEXT:   [[GEP2:%[0-9]+]] = getelementptr inbounds {{.*}}, ptr %0, i32 0, i32 0
; CHECK-NEXT:   store {{.*}} zeroinitializer, ptr [[GEP2]], align 8
; CHECK-NEXT:   ret void
