...
; CHECK-NEXT:    [[TMP3:%.*]] = {{(fsub <2 x double> <double \-0.000000e\+00, double \-0.000000e\+00>,|fneg <2 x double>)}} [[TMP0]]
; CHECK-NEXT:    [[TMP4:%.*]] = {{(fsub <2 x double> <double \-0.000000e\+00, double \-0.000000e\+00>,|fneg <2 x double>)}} [[TMP1]]
; CHECK-NEXT:    [[TMP5:%.*]] = {{(fsub <2 x double> <double \-0.000000e\+00, double \-0.000000e\+00>,|fneg <2 x double>)}} [[TMP2]]
