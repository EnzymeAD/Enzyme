...
; CHECK-NEXT:   %.splatinsert = insertelement <3 x double> {{(poison|undef)}}, double %12, i32 0
...
; CHECK-NEXT:   %.splatinsert1 = insertelement <3 x double> {{(poison|undef)}}, double %13, i32 0
...
; CHECK-NEXT:   %.splatinsert5 = insertelement <3 x double> {{(poison|undef)}}, double %13, i32 0
