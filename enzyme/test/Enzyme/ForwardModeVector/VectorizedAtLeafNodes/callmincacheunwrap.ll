...
; RUN: %opt < %s %loadEnzyme -enzyme -enzyme-preopt=false -enzyme-vectorize-at-leaf-nodes -mem2reg -instsimplify -adce -loop-deletion -correlated-propagation -simplifycfg -adce -S | FileCheck %s
...
define void @caller(i8* %a, <3 x i8>* %b, i8* %c) local_unnamed_addr {
entry:
  call void (i8*, ...) @__enzyme_fwddiff(i8* bitcast (void (double**, i64*)* @_ZL6matvecPKN5Eigen6MatrixIdLin1ELin1ELi0ELin1ELin1EEES3_ to i8*), metadata !"enzyme_width", i64 3 , i8* %a, <3 x i8>* %b, i8* %c)
  ret void
}
...
; CHECK: define internal void @fwddiffe3_ZL6matvecPKN5Eigen6MatrixIdLin1ELin1ELi0ELin1ELin1EEES3_(double** noalias %m_data.i.i.i, <3 x double>** %"m_data.i.i.i'", i64* noalias %m_rows)
; CHECK-NEXT: entry:
; CHECK-NEXT:   call void @fwddiffe3subcall(double** %m_data.i.i.i, <3 x double>** %"m_data.i.i.i'", i64* %m_rows)
; CHECK-NEXT:   store i64 0, i64* %m_rows, align 8
; CHECK-NEXT:   ret void
; CHECK-NEXT: }

; CHECK: define internal void @fwddiffe3subcall(double** %m_data.i.i.i, <3 x double>** %"m_data.i.i.i'", i64* %i7)
; CHECK-NEXT: entry:
...
; CHECK-NEXT:   %"call'ipg" = getelementptr inbounds <3 x double>, <3 x double>* %"mat'ipl", i64 %iv
...
; CHECK-NEXT:   store <3 x double> %2, <3 x double>* %"call'ipg", align 8
