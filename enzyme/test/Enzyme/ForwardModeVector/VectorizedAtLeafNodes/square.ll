...
entry:
  %0 = tail call %struct.Gradients (double (double)*, ...) @__enzyme_fwddiff(double (double)* nonnull @square, metadata !"enzyme_width", i64 3, double %x, [3 x double] [double 1.0, double 10.0, double 100.0])
