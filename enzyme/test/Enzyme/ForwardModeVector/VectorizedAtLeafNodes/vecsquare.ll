...
; CHECK-NEXT:   %.subvector.0 = shufflevector <8 x float> %2, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:   %.subvector.03 = shufflevector <8 x float> %5, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
; CHECK-NEXT:   %"id'ipsv5.vecconcat.subvector.1" = shufflevector <8 x float> %"id'ipsv5.vecconcat", <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
...
; CHECK-NEXT:   %"id'ipsv5.vecconcat.subvector.07" = shufflevector <8 x float> %"id'ipsv5.vecconcat", <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
; CHECK-NEXT:   %"id'ipsv5.vecconcat.subvector.18" = shufflevector <8 x float> %"id'ipsv5.vecconcat", <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
...
; CHECK-NEXT:   %"id'ipsv5.vecconcat.subvector.010" = shufflevector <8 x float> %"id'ipsv5.vecconcat", <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
; CHECK-NEXT:   %"id'ipsv5.vecconcat.subvector.111" = shufflevector <8 x float> %"id'ipsv5.vecconcat", <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
