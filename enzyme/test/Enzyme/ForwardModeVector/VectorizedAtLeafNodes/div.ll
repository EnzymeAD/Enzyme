...
; CHECK-NEXT:   %.splatinsert3 = insertelement <2 x double> poison, double %3, i32 0
; CHECK-NEXT:   %.splat4 = shufflevector <2 x double> %.splatinsert3, <2 x double> poison, <2 x i32> zeroinitializer
