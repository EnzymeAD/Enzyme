...
; CHECK-NEXT:   %"other'.subvector.0" = shufflevector <6 x double> %"other'", <6 x double> undef, <2 x i32> <i32 0, i32 1>
...
; CHECK-NEXT:   %"other'.subvector.1" = shufflevector <6 x double> %"other'", <6 x double> undef, <2 x i32> <i32 2, i32 3>
...
; CHECK-NEXT:   %"other'.subvector.2" = shufflevector <6 x double> %"other'", <6 x double> undef, <2 x i32> <i32 4, i32 5>
...
; CHECK-NEXT:   %.vecpad = shufflevector <2 x double> %7, <2 x double> undef, <4 x i32> <i32 0, i32 1, i32 undef, i32 undef>
