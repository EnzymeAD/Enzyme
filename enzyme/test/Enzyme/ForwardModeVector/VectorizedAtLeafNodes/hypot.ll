...
; CHECK-NEXT: entry:
; CHECK-NEXT:   %0 = extractelement <3 x double> %"x'", i64 0
; CHECK-NEXT:   %1 = fmul fast double %0, %x
; CHECK-NEXT:   %2 = extractelement <3 x double> %"x'", i64 1
; CHECK-NEXT:   %3 = fmul fast double %2, %x
; CHECK-NEXT:   %4 = extractelement <3 x double> %"x'", i64 2
...
; CHECK-NEXT:   %10 = extractelement <3 x double> %"y'", i64 0
; CHECK-NEXT:   %11 = fmul fast double %10, %y
; CHECK-NEXT:   %12 = extractelement <3 x double> %"y'", i64 1
; CHECK-NEXT:   %13 = fmul fast double %12, %y
; CHECK-NEXT:   %14 = extractelement <3 x double> %"y'", i64 2
