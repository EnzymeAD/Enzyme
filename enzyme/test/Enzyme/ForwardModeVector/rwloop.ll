...
; RUN: if [ %llvmver -ge 16 ]; then %opt < %s %newLoadEnzyme -passes="enzyme,function(mem2reg,early-cse,simplifycfg,instsimplify,correlated-propagation,adce)" -enzyme-preopt=false -S | FileCheck %s; fi
