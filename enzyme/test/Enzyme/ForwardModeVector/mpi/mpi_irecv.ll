...
entry:  
  call void (i8*, ...) @__enzyme_fwddiff(i8* bitcast (void (i8**, i32, i32)* @meta to i8*), metadata !"enzyme_width", i64 2, metadata !"enzyme_dup", i8** %ptr, i8** %dptr, i8** %dptr, i32 %numprocprec, i32 %etiquette)
  ret void
}
...
; CHECK: define internal void @fwddiffe2msg1(i8** %ptr, [2 x i8**] %"ptr'", i32 %numprocprec, i32 %etiquette)
; CHECK-NEXT: entry:
; CHECK-NEXT:   %"r2'ipa" = alloca %struct.ompi_request_t*, align 8
; CHECK-NEXT:   %"r2'ipa1" = alloca %struct.ompi_request_t*, align 8
; CHECK-NEXT:   store %struct.ompi_request_t* null, %struct.ompi_request_t** %"r2'ipa", align 8
; CHECK-NEXT:   store %struct.ompi_request_t* null, %struct.ompi_request_t** %"r2'ipa1", align 8
; CHECK-NEXT:   %r2 = alloca %struct.ompi_request_t*, align 8
; CHECK-NEXT:   %s2 = alloca %struct.ompi_status_public_t, align 8
; CHECK-NEXT:   %0 = extractvalue [2 x i8**] %"ptr'", 0
; CHECK-NEXT:  %"into'ipl" = load i8*, i8** %0, align 8
; CHECK-NEXT:   %1 = extractvalue [2 x i8**] %"ptr'", 1
; CHECK-NEXT:   %"into'ipl2" = load i8*, i8** %1, align 8
; CHECK-NEXT:   %into = load i8*, i8** %ptr, align 8
; CHECK-NEXT:   %call2 = call i32 @MPI_Irecv(i8* %into, i32 1, %struct.ompi_datatype_t* bitcast (%struct.ompi_predefined_datatype_t* @ompi_mpi_real to %struct.ompi_datatype_t*), i32 %numprocprec, i32 %etiquette, %struct.ompi_communicator_t* bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_world to %struct.ompi_communicator_t*), %struct.ompi_request_t** nonnull %r2)
; CHECK-NEXT:   %2 = call i32 @MPI_Irecv(i8* %"into'ipl", i32 1, %struct.ompi_datatype_t* bitcast (%struct.ompi_predefined_datatype_t* @ompi_mpi_real to %struct.ompi_datatype_t*), i32 %numprocprec, i32 %etiquette, %struct.ompi_communicator_t* bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_world to %struct.ompi_communicator_t*), %struct.ompi_request_t** %"r2'ipa")
; CHECK-NEXT:   %3 = call i32 @MPI_Irecv(i8* %"into'ipl2", i32 1, %struct.ompi_datatype_t* bitcast (%struct.ompi_predefined_datatype_t* @ompi_mpi_real to %struct.ompi_datatype_t*), i32 %numprocprec, i32 %etiquette, %struct.ompi_communicator_t* bitcast (%struct.ompi_predefined_communicator_t* @ompi_mpi_comm_world to %struct.ompi_communicator_t*), %struct.ompi_request_t** %"r2'ipa1")
; CHECK-NEXT:   %call3 = call i32 @MPI_Wait(%struct.ompi_request_t** nonnull %r2, %struct.ompi_status_public_t* nonnull %s2)
; CHECK-NEXT:   %4 = call i32 @MPI_Wait(%struct.ompi_request_t** %"r2'ipa", %struct.ompi_status_public_t* %s2)
; CHECK-NEXT:   %5 = call i32 @MPI_Wait(%struct.ompi_request_t** %"r2'ipa1", %struct.ompi_status_public_t* %s2)
; CHECK-NEXT:   ret void
; CHECK-NEXT: }
