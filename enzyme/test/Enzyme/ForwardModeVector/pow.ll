...
; CHECK-NEXT:   %11 = select fast i1 %7, double 0.000000e+00, double %10
; CHECK-NEXT:   %12 = extractvalue [2 x double] %"y'", 0
; CHECK-NEXT:   %13 = fmul fast double %12, %11
; CHECK-NEXT:   %[[i14:.+]] = extractvalue [2 x double] %"y'", 1
; CHECK-NEXT:   %[[i15:.+]] = fmul fast double %[[i14]], %11
; CHECK-NEXT:   %[[i12:.+]] = fadd fast double %4, %13
