...
; CHECK-NEXT:   %[[i3:.+]] = fmul double %[[i1]], %[[i2]]
; CHECK-NEXT:   %[[i4:.+]] = extractvalue [3 x double] %"x'", 1
; CHECK-NEXT:   %[[i5:.+]] = fmul double %[[i1]], %[[i4]]
; CHECK-NEXT:   %[[v4:.+]] = extractvalue [3 x double] %"x'", 2
; CHECK-NEXT:   %[[v5:.+]] = fmul double %[[i1]], %[[v4]]
...
; CHECK-NEXT:   %[[i9:.+]] = fmul double %[[i8]], %[[i2]]
; CHECK-NEXT:   %[[i10:.+]] = fmul double %[[i8]], %[[i4]]
; CHECK-NEXT:   %[[v10:.+]] = fmul double %[[i8]], %[[v4]]
; CHECK-NEXT:   %[[i11:.+]] = {{(fneg double)|(fsub double \-0.000000e\+00,)}} %[[i9]]
; CHECK-NEXT:   %[[i12:.+]] = {{(fneg double)|(fsub double \-0.000000e\+00,)}} %[[i10]]
; CHECK-NEXT:   %[[v12:.+]] = {{(fneg double)|(fsub double \-0.000000e\+00,)}} %[[v10]]
