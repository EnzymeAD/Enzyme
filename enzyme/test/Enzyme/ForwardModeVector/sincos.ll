; RUN: %opt < %s %loadEnzyme -enzyme -early-cse -adce -enzyme-preopt=false -S | FileCheck %s
; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,early-cse,adce" -enzyme-preopt=false -S | FileCheck %s
