...
; CHECK-NEXT:    [[TMP3:%.*]] = {{(fsub double \-0.000000e\+00,|fneg double)}} [[TMP0]]
; CHECK-NEXT:    [[TMP4:%.*]] = {{(fsub double \-0.000000e\+00,|fneg double)}} [[TMP1]]
; CHECK-NEXT:    [[TMP5:%.*]] = {{(fsub double \-0.000000e\+00,|fneg double)}} [[TMP2]]
