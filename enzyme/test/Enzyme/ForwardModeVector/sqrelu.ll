...
; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,inline,function(mem2reg,%simplifycfg,adce)" -enzyme-preopt=false -S | FileCheck %s
...
; CHECK-NEXT:    [[TMP11:%.*]] = fcmp fast ueq double [[MUL_I]], 0.000000e+00
...
; CHECK-NEXT:    [[TMP17:%.*]] = fcmp fast ueq double [[MUL_I]], 0.000000e+00
