...
; CHECK-NEXT:    %"'ipl.i" = load double, double* %"arrayidx'ipg.i", align 8
; CHECK-NEXT:    %"'ipl3.i" = load double, double* %"arrayidx'ipg1.i", align 8
; CHECK-NEXT:    %"'ipl4.i" = load double, double* %"arrayidx'ipg2.i", align 8
; CHECK-NEXT:    [[TMP1:%.*]] = load double, double* [[ARRAYIDX_I]], align 8
