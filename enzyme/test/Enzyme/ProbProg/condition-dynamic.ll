...
; CHECK-NEXT:   %has.choice.normal.i = call i1 @has_choice(i8* %observations, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
...
; CHECK-NEXT:   %normal.size.i = call i64 @get_choice(i8* %observations, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0), i8* %4, i64 8)
...
; CHECK-NEXT:   %has.choice.normal.i5 = call i1 @has_choice(i8* %observations, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
...
; CHECK-NEXT:   %normal.size.i6 = call i64 @get_choice(i8* %observations, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i8* %11, i64 8)
...
; CHECK-NEXT:   %18 = call i1 %has_call.i(i8* %observations, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @6, i32 0, i32 0))
...
; CHECK-NEXT:   %19 = call i8* %get_trace.i(i8* %observations, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @6, i32 0, i32 0))
...
; CHECK-NEXT:   call void %insert_call.i(i8* %trace, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @6, i32 0, i32 0), i8* %17)
...
; CHECK-NEXT:   call void @insert_argument(i8* %trace, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @2, i32 0, i32 0), i8* %1, i64 8)
; CHECK-NEXT:   %2 = bitcast double %b to i64
; CHECK-NEXT:   %3 = inttoptr i64 %2 to i8*
; CHECK-NEXT:   call void @insert_argument(i8* %trace, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @3, i32 0, i32 0), i8* %3, i64 8)
; CHECK-NEXT:   %4 = bitcast double* %data to i8*
; CHECK-NEXT:   call void @insert_argument(i8* %trace, i8* nocapture readonly getelementptr inbounds ([5 x i8], [5 x i8]* @4, i32 0, i32 0), i8* %4, i64 0)
; CHECK-NEXT:   %5 = zext i32 %n to i64
; CHECK-NEXT:   %6 = inttoptr i64 %5 to i8*
; CHECK-NEXT:   call void @insert_argument(i8* %trace, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @5, i32 0, i32 0), i8* %6, i64 4)
...
; CHECK-NEXT:   %has.choice.normal.i = call i1 @has_choice(i8* %observations, i8* nocapture readonly getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0))
; CHECK-NEXT:   br i1 %has.choice.normal.i, label %condition.normal.with.trace.i, label %condition.normal.without.trace.i

; CHECK: condition.normal.with.trace.i:                    ; preds = %for.body
; CHECK-NEXT:   %12 = bitcast double* %normal.ptr.i to i8*
; CHECK-NEXT:   %normal.size.i = call i64 @get_choice(i8* %observations, i8* nocapture readonly getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i8* %12, i64 8)
; CHECK-NEXT:   %from.trace.normal.i = load double, double* %normal.ptr.i
