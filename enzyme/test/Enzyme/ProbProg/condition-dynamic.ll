...
; CHECK-NEXT:   %6 = bitcast double* %call.ptr.i to i8*
...
; CHECK-NEXT:   %12 = phi double [ %from.trace.call1.i, %condition.call1.with.trace.i ], [ %sample.call1.i, %condition.call1.without.trace.i ]
...
; CHECK-NEXT:   %has.call.call2 = call i1 %has_call(i8* %observations, i8* nocapture readonly getelementptr inbounds ([21 x i8], [21 x i8]* @3, i32 0, i32 0))
...
; CHECK-NEXT:   %calculate_loss.subtrace = call i8* %get_trace(i8* %observations, i8* nocapture readonly getelementptr inbounds ([21 x i8], [21 x i8]* @3, i32 0, i32 0))
...
; CHECK-NEXT:   call void %insert_call(i8* %trace, i8* nocapture readonly getelementptr inbounds ([21 x i8], [21 x i8]* @3, i32 0, i32 0), i8* %trace3)
...
; CHECK-NEXT:   %insert_argument = load void (i8*, i8*, i8*, i64)*, void (i8*, i8*, i8*, i64)** @insert_argument
; CHECK-NEXT:   call void %insert_argument(i8* %trace, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @4, i32 0, i32 0), i8* %1, i64 8)
; CHECK-NEXT:   %2 = bitcast double %b to i64
; CHECK-NEXT:   %3 = inttoptr i64 %2 to i8*
; CHECK-NEXT:   %insert_argument1 = load void (i8*, i8*, i8*, i64)*, void (i8*, i8*, i8*, i64)** @insert_argument
; CHECK-NEXT:   call void %insert_argument1(i8* %trace, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @5, i32 0, i32 0), i8* %3, i64 8)
...
; CHECK-NEXT:   call void %insert_argument2(i8* %trace, i8* nocapture readonly getelementptr inbounds ([5 x i8], [5 x i8]* @6, i32 0, i32 0), i8* %4, i64 0)
...
; CHECK-NEXT:   call void %insert_argument3(i8* %trace, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @7, i32 0, i32 0), i8* %6, i64 4)
