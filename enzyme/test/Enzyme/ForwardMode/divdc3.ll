...
; CHECK-NEXT:   %7 = fmul double %yre, %"xim'"
; CHECK-NEXT:   %8 = fmul double %"xre'", %yim
; CHECK-NEXT:   %9 = fsub double %7, %8
; CHECK-NEXT:   %10 = fdiv double %9, %5
; CHECK-NEXT:   %11 = {{(fneg double)|(fsub double \-0.000000e\+00,)}} %xre
; CHECK-NEXT:   %12 = {{(fneg double)|(fsub double \-0.000000e\+00,)}} %xim
; CHECK-NEXT:   %13 = fsub double %3, %4
; CHECK-NEXT:   %14 = fmul double %yre, %yim
; CHECK-NEXT:   %15 = fadd double %14, %14
; CHECK-NEXT:   %16 = fmul double %11, %13
; CHECK-NEXT:   %17 = fmul double %12, %15
; CHECK-NEXT:   %18 = fadd double %16, %17
; CHECK-NEXT:   %19 = fmul double %13, %13
; CHECK-NEXT:   %20 = fmul double %15, %15
; CHECK-NEXT:   %21 = fadd double %19, %20
; CHECK-NEXT:   %22 = fdiv double %18, %21
; CHECK-NEXT:   %23 = fmul double %"yre'", %22
; CHECK-NEXT:   %24 = fmul double %"yim'", %15
; CHECK-NEXT:   %25 = fsub double %23, %24
; CHECK-NEXT:   %26 = fmul double %"yre'", %15
; CHECK-NEXT:   %27 = fmul double %22, %"yim'"
; CHECK-NEXT:   %28 = fadd double %26, %27
; CHECK-NEXT:   %29 = fadd double %6, %25
; CHECK-NEXT:   %30 = fadd double %10, %28
