...
entry:
  ...
  %a7 = call double @julia_f_kw__kw_6800([1 x double]* %a2, double %a0) readnone "enzyme_preserve_primal"="*"
  ret double %a7
}

; CHECK: define internal double @fwddiffejulia_g_6797_inner.1(double %a0, double %"a0'", i8* %a1)
; CHECK-NEXT: entry:
; CHECK-NEXT:   %a2 = bitcast i8* %a1 to [1 x double]*
; CHECK-NEXT:   %0 = call fast double @fwddiffejulia_f_kw__kw_6800([1 x double]* %a2, double %a0, double %"a0'")
