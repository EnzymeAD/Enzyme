...
; CHECK-NEXT: entry:
; CHECK-NEXT:   %0 = {{(fsub <2 x double> <double \-0.000000e\+00, double \-0.000000e\+00>,|fneg <2 x double>)}} %"x'"
; CHECK-NEXT:   %1 = select{{( fast)?}} <2 x i1> <i1 false, i1 true>, <2 x double> %"x'", <2 x double> %0
