...
define dso_local void @_Z6squared(%"struct.std::array"* noalias nocapture sret readonly %agg.result, double %x) #0 {
entry:
...
; CHECK-NEXT: entry:  
; CHECK-NEXT:   call void @fwddiffe_Z6squared(%"struct.std::array"* %agg.result, double %x, double 1.000000e+00)
; CHECK-NEXT:   ret void
; CHECK-NEXT: }


; CHECK: define internal void @fwddiffe_Z6squared(%"struct.std::array"* nocapture "enzyme_sret" %"agg.result'", double %x, double %"x'")
; CHECK-NEXT: entry:  
