...
; CHECK-NEXT: entry:
; CHECK-DAG:   %[[a2:.+]] = fmul double %"x'", 2.000000e+00
; CHECK-DAG:   %[[a0:.+]] = fmul double %x, %x
; CHECK-DAG:   %[[a1:.+]] = fadd double %[[a0]], 4.000000e+00
; CHECK-DAG:   %[[a4:.+]] = fdiv double %[[a2]], %[[a1]]
; CHECK-DAG:   %[[a7:.+]] = {{(fneg double)|(fsub double \-0.000000e\+00,)}} %[[a4]]
