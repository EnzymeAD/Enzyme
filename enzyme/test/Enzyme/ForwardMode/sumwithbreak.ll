...
; CHECK-NEXT:   %"data.016'" = phi {{(fast )?}}double [ %[[i4:.+]], %if.end ], [ 0.000000e+00, %entry ]
...
; CHECK-NEXT:   %[[i1:.+]] = fadd fast double %[[i0]], %"data.016'"
