; RUN: %opt < %s %loadEnzyme -enzyme -enzyme-preopt=false -mem2reg -early-cse -adce -simplifycfg -S | FileCheck %s
; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,function(mem2reg,early-cse,adce,simplify-cfg)" -enzyme-preopt=false -S | FileCheck %s
