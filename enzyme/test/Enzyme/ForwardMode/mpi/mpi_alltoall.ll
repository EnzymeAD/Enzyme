...
entry:
  call void (i8*, ...) @__enzyme_fwddiff(i8* bitcast (void (float*, i32, float*)* @mpi_alltoall_test to i8*), float* noundef %sendbuf, float* noundef %dsendbuf, i32 noundef %count, float* noundef %recvbuf, float* noundef %drecvbuf)
...
; CHECK: define internal void @fwddiffempi_alltoall_test(float* noundef %0, float* %"'", i32 noundef %1, float* noundef %2, float* %"'1") #0 {
