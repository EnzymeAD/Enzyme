...
; }
; LI
; OtherSI does not dominate LI but should still be considered intermediate

define i32 @test_conditional_between(ptr noalias %ptr, i1 %cond) {
entry:
...
; CHECK: define i32 @test_conditional_between(ptr noalias %ptr, i1 %cond)
; CHECK: entry:
