...
; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,function(inline,mem2reg,instsimplify,adce,loop-deletion,correlated-propagation,simplifycfg,early-cse,simplifycfg)" -enzyme-preopt=false -S | FileCheck %s
