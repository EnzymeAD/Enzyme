...
; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,inline,function(mem2reg,instsimplify,adce,loop-deletion,correlated-propagation,simplifycfg,early-cse,simplifycfg)" -enzyme-preopt=false -S | FileCheck %s
