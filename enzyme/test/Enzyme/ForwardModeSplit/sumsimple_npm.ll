; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,inline,mem2reg,instsimplify,adce,loop-deletion,correlated-propagation,simplifycfg,early-cse,simplifycfg"  -enzyme-preopt=false -S | FileCheck %s
...
; CHECK-NEXT:   %[[il_phi:.+]] = load double*, double** %2, align 8, !invariant.group !2
