...
entry:
  %0 = tail call { double, double } ({ double, double } ({ double, double })*, ...) @__enzyme_fwdsplit({ double, double } ({ double, double })*  @tester, { double, double } %x, { double, double } { double 1.0, double 1.0 })
  ret { double, double } %0
}
