...
; RUN: if [ %llvmver -ge 16 ]; then %opt < %s %newLoadEnzyme -passes="enzyme,function(mem2reg,instsimplify,adce,correlated-propagation,simplifycfg,adce)" -enzyme-preopt=false -S | FileCheck %s; fi
