...
; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,function(mem2reg,simplifycfg,early-cse-memssa,instsimplify,correlated-propagation,adce)" -enzyme-preopt=false -S | FileCheck %s
