; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,inline,mem2reg,gvn,instsimplify,adce,correlated-propagation,simplifycfg"  -enzyme-preopt=false -S | FileCheck %s
...
; CHECK-NEXT:   %.pre = load i64*, i64** %[[i3]], align 8, !invariant.group !5
; CHECK-NEXT:   %.pre6 = load double*, double** %[[i4]], align 8, !invariant.group !6
...
; CHECK-NEXT:   %idx = load i64, i64* %[[i5]], align 8, !invariant.group !7
; CHECK-NEXT:   %iv.next2 = add nuw nsw i64 %iv1, 1
; CHECK-NEXT:   %[[i6:.+]] = getelementptr inbounds double, double* %.pre6, i64 %iv1
; CHECK-NEXT:   %ld = load double, double* %[[i6]], align 8, !invariant.group !8
