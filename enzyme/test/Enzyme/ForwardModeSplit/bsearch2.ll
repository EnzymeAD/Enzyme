...
entry:
  %call = tail call fast double @__enzyme_fwdsplit(i8* bitcast (double (double*, i64)* @f to i8*), double* %x, double* %xp, i64 %n, i8* null)
  ret double %call
}

declare dso_local double @__enzyme_fwdsplit(i8*, double*, double*, i64, i8*) local_unnamed_addr
