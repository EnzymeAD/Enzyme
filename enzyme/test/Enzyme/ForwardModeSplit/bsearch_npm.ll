; RUN: %opt < %s %newLoadEnzyme -passes="enzyme,inline,mem2reg,gvn,instsimplify,correlated-propagation,adce,simplifycfg"  -enzyme-preopt=false -S | FileCheck %s
...
; CHECK-NEXT:   %.pre = load i1*, i1** %[[i1]], align 8, !invariant.group !2
...
; CHECK-NEXT:   %cmp = load i1, i1* %[[i2]], align 1, !invariant.group !3
