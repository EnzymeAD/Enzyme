...
; CHECK: define internal void @batch_addOneMem([4 x double*] %0)
; CHECK-NEXT: entry:
...
; CHECK-NEXT:   %1 = load double, double* %unwrap.x0, align 8
; CHECK-NEXT:   %2 = load double, double* %unwrap.x1, align 8
; CHECK-NEXT:   %3 = load double, double* %unwrap.x2, align 8
; CHECK-NEXT:   %4 = load double, double* %unwrap.x3, align 8
; CHECK-NEXT:   %add0 = fadd fast double %1, 1.000000e+00
; CHECK-NEXT:   %add1 = fadd fast double %2, 1.000000e+00
; CHECK-NEXT:   %add2 = fadd fast double %3, 1.000000e+00
; CHECK-NEXT:   %add3 = fadd fast double %4, 1.000000e+00
