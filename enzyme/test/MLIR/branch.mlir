...
// CHECK-NEXT:     %0 = call @fwddiffesquare(%arg0, %arg1, %arg2, %arg3) : (f64, f64, f64, f64) -> f64
// CHECK-NEXT:     return %0 : f64
// CHECK-NEXT:   }
// CHECK:   func.func private @fwddiffesquare(%arg0: f64, %arg1: f64, %arg2: f64, %arg3: f64) -> f64 {
// CHECK-NEXT:     %0 = arith.cmpf ult, %arg0, %arg2 : f64
// CHECK-NEXT:     cf.cond_br %0, ^bb1(%arg0, %arg1 : f64, f64), ^bb1(%arg2, %arg3 : f64, f64)
// CHECK-NEXT:   ^bb1(%1: f64, %2: f64):  // 2 preds: ^bb0, ^bb0
