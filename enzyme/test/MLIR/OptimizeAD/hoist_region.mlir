...
func.func @fwfoo(%arg0: f64, %arg1: f64,%xx: f64) -> f64 {
...
// CHECK: func.func @fwfoo(%arg0: f64, %arg1: f64, %arg2: f64) -> f64 {
// CHECK-NEXT:   %c10 = arith.constant 10 : index
// CHECK-NEXT:   %c1 = arith.constant 1 : index
// CHECK-NEXT:   %cst = arith.constant 2.500000e+00 : f64
// CHECK-NEXT:   %cst_0 = arith.constant 2.000000e+00 : f64
// CHECK-NEXT:   %cst_1 = arith.constant 0.000000e+00 : f64
// CHECK-NEXT:   %cst_2 = arith.constant 1.000000e+02 : f64
// CHECK-NEXT:   %0 = arith.mulf %arg2, %cst_0 : f64
// CHECK-NEXT:   %1 = scf.for %arg3 = %c1 to %c10 step %c1 iter_args(%arg4 = %cst) -> (f64) {
// CHECK-NEXT:     %3 = arith.mulf %arg4, %cst_2 : f64
// CHECK-NEXT:     %4 = scf.for %arg5 = %c1 to %c10 step %c1 iter_args(%arg6 = %3) -> (f64) {
// CHECK-NEXT:       %5 = arith.addf %3, %0 : f64
// CHECK-NEXT:       scf.yield %5 : f64
// CHECK-NEXT:     }
// CHECK-NEXT:     scf.yield %4 : f64
// CHECK-NEXT:   }
// CHECK-NEXT:   %2 = enzyme.fwddiff_region(%arg0, %arg1) {
// CHECK-NEXT:   ^bb0(%arg3: f64):
// CHECK-NEXT:     %3 = arith.mulf %arg3, %arg3 : f64
// CHECK-NEXT:     %4 = arith.mulf %3, %0 : f64
// CHECK-NEXT:     %5 = arith.mulf %4, %1 : f64
// CHECK-NEXT:     %6 = arith.addf %4, %cst_1 : f64
// CHECK-NEXT:     %7 = scf.for %arg4 = %c1 to %c10 step %c1 iter_args(%arg5 = %6) -> (f64) {
// CHECK-NEXT:       %9 = arith.addf %arg5, %4 : f64
// CHECK-NEXT:       %10 = arith.mulf %9, %arg5 : f64
...
func.func @fwbar(%arg0: f64, %arg1: f64, %arg2: f64, %arg3: i1) -> f64 {
  %0 = enzyme.fwddiff_region(%arg0, %arg1) {
  ^bb0(%arg4: f64):
    %cst = arith.constant 2.000000e+00 : f64
    %1 = arith.mulf %cst, %arg2 : f64
...
// CHECK: func.func @fwbar(%arg0: f64, %arg1: f64, %arg2: f64, %arg3: i1) -> f64 {
// CHECK-NEXT:   %cst = arith.constant 2.000000e+00 : f64
// CHECK-NEXT:   %0 = arith.mulf %arg2, %cst : f64
// CHECK-NEXT:   %1 = arith.addf %0, %0 : f64
// CHECK-NEXT:   %2 = enzyme.fwddiff_region(%arg0, %arg1) {
...
func.func @fwbaz(%arg0: f64, %arg1: f64, %arg2: f64, %arg3: i1) -> f64 { 
  %0 = enzyme.fwddiff_region(%arg0, %arg1) {
  ^bb0(%arg4: f64, %arg00 : f64):
    %cst = arith.constant 2.000000e+00 : f64 // h
    %1 = arith.mulf %cst, %arg2 : f64 // h 
    %2 = arith.mulf %arg4, %arg4 : f64 // h
    cf.cond_br %arg3, ^bb1(%1 : f64), ^bb2(%arg2 : f64)
...
// CHECK: func.func @fwbaz(%arg0: f64, %arg1: f64, %arg2: f64, %arg3: i1) -> f64 {
// CHECK-NEXT:   %cst = arith.constant 2.000000e+00 : f64
// CHECK-NEXT:   %0 = arith.mulf %arg2, %cst : f64
// CHECK-NEXT:   %1 = arith.mulf %arg0, %arg0 : f64
// CHECK-NEXT:   %2 = arith.addf %0, %0 : f64
// CHECK-NEXT:   %3 = enzyme.fwddiff_region(%arg0, %arg1) {
// CHECK-NEXT:   ^bb0(%arg4: f64, %arg5: f64):
// CHECK-NEXT:     cf.cond_br %arg3, ^bb1, ^bb2
// CHECK-NEXT:   ^bb1:  // pred: ^bb0
// CHECK-NEXT:     %4 = arith.mulf %0, %0 : f64
// CHECK-NEXT:     cf.br ^bb3(%4 : f64)
