...
// CHECK:          distinct[0]<#enzyme.pseudoclass<@fasten_main(10, 0)>> originates from [distinct[0]<#enzyme.argorigin<@fasten_main(2)>>, distinct[1]<#enzyme.argorigin<@fasten_main(3)>>, distinct[2]<#enzyme.argorigin<@fasten_main(4)>>, distinct[3]<#enzyme.argorigin<@fasten_main(5)>>, distinct[4]<#enzyme.argorigin<@fasten_main(6)>>, distinct[5]<#enzyme.argorigin<@fasten_main(7)>>, distinct[6]<#enzyme.argorigin<@fasten_main(8)>>, distinct[7]<#enzyme.argorigin<@fasten_main(9)>>, distinct[8]<#enzyme.argorigin<@fasten_main(10)>>, distinct[9]<#enzyme.argorigin<@fasten_main(11)>>]
...
// CHECK-NEXT:    <empty>
// CHECK: value origin summary:
// CHECK:         distinct[0]<#enzyme.pseudoclass<@onecompute(8, 0)>> originates from [distinct[0]<#enzyme.argorigin<@onecompute(0)>>, distinct[1]<#enzyme.argorigin<@onecompute(1)>>, distinct[2]<#enzyme.argorigin<@onecompute(2)>>, distinct[3]<#enzyme.argorigin<@onecompute(3)>>, distinct[4]<#enzyme.argorigin<@onecompute(4)>>, distinct[5]<#enzyme.argorigin<@onecompute(5)>>, distinct[6]<#enzyme.argorigin<@onecompute(6)>>, distinct[7]<#enzyme.argorigin<@onecompute(7)>>, distinct[8]<#enzyme.argorigin<@onecompute(8)>>, distinct[9]<#enzyme.argorigin<@onecompute(9)>>]
