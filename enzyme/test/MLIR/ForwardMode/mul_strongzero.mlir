...
// CHECK-NEXT:    %3 = arith.cmpf oeq, %arg1, %cst_0 fastmath<fast> : f64
// CHECK-NEXT:    %4 = arith.mulf %arg1, %arg0 fastmath<fast> : f64
// CHECK-NEXT:    %5 = arith.select %3, %cst_0, %4 : f64
// CHECK-NEXT:    %6 = arith.addf %2, %5 fastmath<fast> : f64
