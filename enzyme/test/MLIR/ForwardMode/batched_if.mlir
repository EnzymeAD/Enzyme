...
// CHECK-NEXT:      %[[t5:.+]] = arith.mulf %[[arg1]], %[[t4]] fastmath<fast> : tensor<2xf64>
// CHECK-NEXT:      %[[t6:.+]] = "enzyme.broadcast"(%[[arg0]]) <{shape = array<i64: 2>}> : (f64) -> tensor<2xf64>
// CHECK-NEXT:      %[[t7:.+]] = arith.mulf %[[arg1]], %[[t6]] fastmath<fast> : tensor<2xf64>
// CHECK-NEXT:      %[[t8:.+]] = arith.addf %[[t5]], %[[t7]] fastmath<fast> : tensor<2xf64>
// CHECK-NEXT:      %[[t9:.+]] = arith.mulf %[[arg0]], %[[arg0]] : f64
// CHECK-NEXT:      scf.yield %[[t9]], %[[t8]], %[[cst2]] : f64, tensor<2xf64>, f64
// CHECK-NEXT:    } else {
// CHECK-NEXT:      %[[e4:.+]] = arith.addf %[[arg1]], %[[arg1]] fastmath<fast> : tensor<2xf64>
...
// CHECK-NEXT:    %[[r2:.+]] = arith.mulf %[[r0]]#1, %[[r1]] fastmath<fast> : tensor<2xf64>
