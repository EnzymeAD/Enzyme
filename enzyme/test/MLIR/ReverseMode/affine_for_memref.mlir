...
// CHECK-NEXT:     %[[alloc1:.+]] = memref.alloc(%arg2) : memref<?xindex>
// CHECK-NEXT:     %[[alloc0:.+]] = memref.alloc(%arg2) : memref<?xf32>
// CHECK-NEXT:     affine.for %arg3 = 0 to %arg2 {
// CHECK-NEXT:       memref.store %arg3, %[[alloc1]][%arg3] : memref<?xindex>
...
// CHECK-NEXT:       %[[a2:.+]] = memref.load %[[alloc1]][%[[ridx]]] : memref<?xindex>
...
// CHECK-NEXT:     memref.dealloc %[[alloc1]] : memref<?xindex>
// CHECK-NEXT:     return
// CHECK-NEXT:   }
// CHECK-NEXT: }
