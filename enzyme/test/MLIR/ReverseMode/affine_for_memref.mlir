...
// CHECK-DAG: #[[STORE_MAP:.+]] = affine_map<(d0) -> (d0 * 2 + 1)>
// CHECK-DAG: #[[LOAD_MAP:.+]] = affine_map<(d0) -> (d0 * 2)>
...
// CHECK-NEXT:       %[[a3:.+]] = affine.apply #[[STORE_MAP]](%[[ridx]])
...
// CHECK-NEXT:       %[[a8:.+]] = affine.apply #[[LOAD_MAP]](%[[ridx]])
