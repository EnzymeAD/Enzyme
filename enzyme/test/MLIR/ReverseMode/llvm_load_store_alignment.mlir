...
llvm.func @loadstore(%a: !llvm.ptr, %b: f32) -> f32 {
  ...
  llvm.store %b, %a <alignment = 16> : f32, !llvm.ptr
  %0 = llvm.load %a <alignment = 16> : !llvm.ptr -> f32
  llvm.return %0 : f32
}
...
// CHECK:          llvm.load %[[da:.+]] <alignment = 16> : !llvm.ptr -> f32
// CHECK:          llvm.store %{{.+}}, %[[da]] <alignment = 16> : f32, !llvm.ptr
