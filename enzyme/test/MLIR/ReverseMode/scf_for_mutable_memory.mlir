...
// CHECK:           }
// CHECK:           %[[FOR_1:.*]] = scf.for %[[IV_REV:.*]] = %[[C0]] to %[[C10]] step %[[C1]] iter_args(%[[DACC:.*]] = %[[ARG2]]) -> (f64) {
...
// CHECK:             %[[ADDF_3:.*]] = arith.addf %[[DACC]], %[[DVAL_0]] fastmath<fast> : f64
...
// CHECK:             %[[ADDF_6:.*]] = arith.addf %[[DVAL_1]], %[[ADDF_3]] fastmath<fast> : f64
