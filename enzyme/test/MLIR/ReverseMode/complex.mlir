...
// CHECK-NEXT:    %0 = arith.addf %arg1, %cst fastmath<fast> : f32
// CHECK-NEXT:    %1 = arith.addf %arg2, %cst fastmath<fast> : f32
// CHECK-NEXT:    %2 = arith.negf %1 fastmath<fast> : f32
// CHECK-NEXT:    %3 = complex.create %cst, %2 : complex<f32>
// CHECK-NEXT:    %4 = complex.conj %3 : complex<f32>
// CHECK-NEXT:    %5 = complex.add %cst_0, %4 fastmath<fast> : complex<f32>
// CHECK-NEXT:    %6 = complex.create %0, %cst : complex<f32>
// CHECK-NEXT:    %7 = complex.conj %6 : complex<f32>
// CHECK-NEXT:    %8 = complex.add %5, %7 fastmath<fast> : complex<f32>
