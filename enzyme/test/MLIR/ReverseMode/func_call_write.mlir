...
// CHECK-NEXT:    %0:2 = call @f_reverse_rule_primal(%arg0, %arg1, %arg2) : (memref<f32>, memref<f32>, f32) -> (f32, memref<f32>)
// CHECK-NEXT:    %1 = call @f_reverse_rule_reverse(%arg3, %0#1) : (f32, memref<f32>) -> f32
// CHECK-NEXT:    return %1 : f32
// CHECK-NEXT:  }

// CHECK:  func.func private @f_reverse_rule_primal(%arg0: memref<f32>, %arg1: memref<f32>, %arg2: f32) -> (f32, memref<f32>) {
// CHECK-NEXT:    memref.store %arg2, %arg0[] : memref<f32>
// CHECK-NEXT:    %0 = memref.load %arg0[] : memref<f32>
// CHECK-NEXT:    return %0, %arg1 : f32, memref<f32>
// CHECK-NEXT:  }
