...
// CHECK-NEXT:    %8:3 = enzyme.autodiff_region(%1, %cst_3) {
// CHECK-NEXT:    ^bb0(%arg3: tensor<2xf64>):
// CHECK-NEXT:      %23:3 = func.call @test.update_0(%0, %arg3, %output_rng_state, %arg1, %arg2) : (!enzyme.Trace, tensor<2xf64>, tensor<2xui64>, tensor<f64>, tensor<f64>) -> (!enzyme.Trace, tensor<f64>, tensor<2xui64>)
// CHECK-NEXT:      %24 = arith.negf %23#1 : tensor<f64>
// CHECK-NEXT:      enzyme.yield %24, %23#0, %23#2 : tensor<f64>, !enzyme.Trace, tensor<2xui64>
// CHECK-NEXT:    } attributes {activity = [#enzyme<activity enzyme_active>], ret_activity = [#enzyme<activity enzyme_activenoneed>, #enzyme<activity enzyme_const>, #enzyme<activity enzyme_const>]} : (tensor<2xf64>, tensor<f64>) -> (!enzyme.Trace, tensor<2xui64>, tensor<2xf64>)
...
// CHECK-NEXT:    %11:5 = enzyme.loop(%cst_1 : tensor<i64>) to(%cst_5 : tensor<i64>) step(%cst_0 : tensor<i64>) iter_args(%1, %result, %8#2, %0, %8#1 : tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, !enzyme.Trace, tensor<2xui64>) -> tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, !enzyme.Trace, tensor<2xui64> {
...
// CHECK-NEXT:        %31:3 = func.call @test.update(%arg7, %arg9, %arg8, %arg1, %arg2) : (!enzyme.Trace, tensor<2xf64>, tensor<2xui64>, tensor<f64>, tensor<f64>) -> (!enzyme.Trace, tensor<f64>, tensor<2xui64>)
// CHECK-NEXT:        %32 = arith.negf %31#1 : tensor<f64>
// CHECK-NEXT:        enzyme.yield %32, %31#0, %31#2 : tensor<f64>, !enzyme.Trace, tensor<2xui64>
// CHECK-NEXT:      } attributes {activity = [#enzyme<activity enzyme_active>], ret_activity = [#enzyme<activity enzyme_activenoneed>, #enzyme<activity enzyme_const>, #enzyme<activity enzyme_const>]} : (tensor<2xf64>, tensor<f64>) -> (!enzyme.Trace, tensor<2xui64>, tensor<2xf64>)
// CHECK-NEXT:      %29 = arith.mulf %10, %28#2 : tensor<2xf64>
// CHECK-NEXT:      %30 = arith.subf %24, %29 : tensor<2xf64>
// CHECK-NEXT:      enzyme.yield %27, %30, %28#2, %28#0, %28#1 : tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, !enzyme.Trace, tensor<2xui64>
// CHECK-NEXT:    }
...
// CHECK-NEXT:    %output_rng_state_8, %result_9 = enzyme.random %11#4, %cst_4, %cst_3 {rng_distribution = #enzyme<rng_distribution UNIFORM>} : (tensor<2xui64>, tensor<f64>, tensor<f64>) -> (tensor<2xui64>, tensor<f64>)
// CHECK-NEXT:    %21 = arith.cmpf olt, %result_9, %20 : tensor<f64>
// CHECK-NEXT:    %22 = enzyme.selectTrace %21, %11#3, %0 : tensor<i1>
...
// CHECK:  func.func @test.update_0(%arg0: !enzyme.Trace, %arg1: tensor<2xf64>, %arg2: tensor<2xui64>, %arg3: tensor<f64>, %arg4: tensor<f64>) -> (!enzyme.Trace, tensor<f64>, tensor<2xui64>) {
// CHECK-NEXT:    %cst = arith.constant dense<0.000000e+00> : tensor<f64>
// CHECK-NEXT:    %0 = enzyme.initTrace : !enzyme.Trace
// CHECK-NEXT:    %1 = enzyme.unflatten_slice %arg1[0] : tensor<2xf64> -> tensor<f64>
// CHECK-NEXT:    %2 = call @logpdf(%1, %arg3, %arg4) : (tensor<f64>, tensor<f64>, tensor<f64>) -> tensor<f64>
