...
module {
  ...
  func.func @nuts(%rng : tensor<2xui64>, %mean : tensor<f64>, %stddev : tensor<f64>) -> (!enzyme.Trace, tensor<i1>, tensor<2xui64>) {
    ...
    %res:3 = enzyme.mcmc @test(%rng, %mean, %stddev) given %init_trace
      ...
      step_size = %step_size
      { nuts_config = #enzyme.nuts_config<max_tree_depth = 10>, name = "nuts", selection = [[#enzyme.symbol<1>], [#enzyme.symbol<2>]] } : (tensor<2xui64>, tensor<f64>, tensor<f64>, !enzyme.Trace, tensor<2x2xf64>, tensor<f64>) -> (!enzyme.Trace, tensor<i1>, tensor<2xui64>)
...
// CHECK-NEXT:      %cst_6 = arith.constant dense<false> : tensor<i1>
// CHECK-NEXT:      %cst_7 = arith.constant dense<0> : tensor<i64>
// CHECK-NEXT:      %cst_8 = arith.constant dense<5.000000e-01> : tensor<f64>
// CHECK-NEXT:      %cst_9 = arith.constant dense<0.000000e+00> : tensor<f64>
// CHECK-NEXT:      %cst_10 = arith.constant dense<1.000000e+03> : tensor<f64>
// CHECK-NEXT:      %cst_11 = arith.constant dense<1.000000e+00> : tensor<f64>
...
// CHECK-NEXT:      %6:2 = enzyme.autodiff_region(%3, %cst_11) {
// CHECK-NEXT:      ^bb0(%arg3: tensor<2xf64>):
// CHECK-NEXT:        %17:3 = func.call @test.update_1(%0, %arg3, %2#1, %arg1, %arg2) : (!enzyme.Trace, tensor<2xf64>, tensor<2xui64>, tensor<f64>, tensor<f64>) -> (!enzyme.Trace, tensor<f64>, tensor<2xui64>)
...
// CHECK-NEXT:      %output_rng_state, %result = enzyme.random %8, %cst_9, %cst_11 {rng_distribution = #enzyme<rng_distribution NORMAL>} : (tensor<2xui64>, tensor<f64>, tensor<f64>) -> (tensor<2xui64>, tensor<2xf64>)
...
// CHECK-NEXT:      %13 = arith.mulf %12, %cst_8 : tensor<f64>
// CHECK-NEXT:      %14 = arith.addf %5, %13 : tensor<f64>
// CHECK-NEXT:      %15:18 = enzyme.while_loop(%3, %10, %6#1, %3, %10, %6#1, %3, %6#1, %5, %14, %cst_7, %cst_9, %cst_6, %cst_6, %cst_9, %cst_7, %10, %7#2 : tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, tensor<f64>, tensor<f64>, tensor<i64>, tensor<f64>, tensor<i1>, tensor<i1>, tensor<f64>, tensor<i64>, tensor<2xf64>, tensor<2xui64>) -> tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, tensor<2xf64>, tensor<f64>, tensor<f64>, tensor<i64>, tensor<f64>, tensor<i1>, tensor<i1>, tensor<f64>, tensor<i64>, tensor<2xf64>, tensor<2xui64> condition {
...
// CHECK-NEXT:        %output_rng_state_14, %result_15 = enzyme.random %17#1, %cst_9, %cst_11 {rng_distribution = #enzyme<rng_distribution UNIFORM>} : (tensor<2xui64>, tensor<f64>, tensor<f64>) -> (tensor<2xui64>, tensor<f64>)
// CHECK-NEXT:        %18 = arith.cmpf olt, %result_15, %cst_8 : tensor<f64>
...
// CHECK-NEXT:          %66 = arith.mulf %64, %cst_8 : tensor<f64>
...
// CHECK-NEXT:          %73:3 = enzyme.autodiff_region(%72, %cst_11) {
...
// CHECK-NEXT:          %78 = arith.mulf %77, %cst_8 : tensor<f64>
...
// CHECK-NEXT:          %84 = arith.cmpf ogt, %82, %cst_10 : tensor<f64>
// CHECK-NEXT:          %85 = arith.negf %82 : tensor<f64>
// CHECK-NEXT:          %86 = math.exp %85 : tensor<f64>
// CHECK-NEXT:          %87 = arith.minimumf %86, %cst_11 : tensor<f64>
...
// CHECK-NEXT:          %99 = arith.addf %98, %cst_11 : tensor<f64>
// CHECK-NEXT:          %100 = arith.divf %cst_11, %99 : tensor<f64>
// CHECK-NEXT:          %output_rng_state_18, %result_19 = enzyme.random %63#1, %cst_9, %cst_11 {rng_distribution = #enzyme<rng_distribution UNIFORM>} : (tensor<2xui64>, tensor<f64>, tensor<f64>) -> (tensor<2xui64>, tensor<f64>)
...
// CHECK-NEXT:          %112 = arith.cmpi eq, %arg36, %cst_7 : tensor<i64>
...
// CHECK-NEXT:          %125 = arith.select %112, %cst_7, %107 : tensor<i1>, tensor<i64>
...
// CHECK-NEXT:          %140 = arith.cmpi eq, %139, %cst_7 : tensor<i64>
...
// CHECK-NEXT:          %146:2 = enzyme.while_loop(%131, %cst_6 : tensor<i64>, tensor<i1>) -> tensor<i64>, tensor<i1> condition {
...
// CHECK-NEXT:            %155 = "enzyme.broadcast"(%cst_8) <{shape = array<i64: 2>}> : (tensor<f64>) -> tensor<2xf64>
...
// CHECK-NEXT:            %161 = arith.cmpf ole, %159, %cst_9 : tensor<f64>
// CHECK-NEXT:            %162 = arith.cmpf ole, %160, %cst_9 : tensor<f64>
...
// CHECK-NEXT:          }
// CHECK-NEXT:          %147 = arith.select %112, %cst_6, %146#1 : tensor<i1>, tensor<i1>
...
// CHECK-NEXT:        %32 = arith.minimumf %31, %cst_11 : tensor<f64>
// CHECK-NEXT:        %33 = arith.ori %21#12, %21#13 : tensor<i1>
// CHECK-NEXT:        %34 = arith.select %33, %cst_9, %32 : tensor<i1>, tensor<f64>
// CHECK-NEXT:        %output_rng_state_16, %result_17 = enzyme.random %19#1, %cst_9, %cst_11 {rng_distribution = #enzyme<rng_distribution UNIFORM>} : (tensor<2xui64>, tensor<f64>, tensor<f64>) -> (tensor<2xui64>, tensor<f64>)
...
// CHECK-NEXT:        %45 = "enzyme.broadcast"(%cst_8) <{shape = array<i64: 2>}> : (tensor<f64>) -> tensor<2xf64>
...
// CHECK-NEXT:        %51 = arith.cmpf ole, %49, %cst_9 : tensor<f64>
// CHECK-NEXT:        %52 = arith.cmpf ole, %50, %cst_9 : tensor<f64>
...
// CHECK-NEXT:      }
// CHECK-NEXT:      %16:3 = call @test.update(%0, %15#6, %7#0, %arg1, %arg2) : (!enzyme.Trace, tensor<2xf64>, tensor<2xui64>, tensor<f64>, tensor<f64>) -> (!enzyme.Trace, tensor<f64>, tensor<2xui64>)
