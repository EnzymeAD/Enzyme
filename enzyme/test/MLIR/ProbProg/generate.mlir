...
module {
  ...
  func.func @generate(%rng : tensor<2xui64>, %mean : tensor<f64>, %stddev : tensor<f64>) -> (!enzyme.Trace, tensor<f64>, tensor<2xui64>, tensor<f64>) {
    ...
    // CHECK: %1:4 = call @test.generate(%0, %arg0, %arg1, %arg2) : (!enzyme.Constraint, tensor<2xui64>, tensor<f64>, tensor<f64>) -> (!enzyme.Trace, tensor<f64>, tensor<2xui64>, tensor<f64>)
...
// CHECK-NEXT:    %1:2 = call @normal(%arg1, %arg2, %arg3) : (tensor<2xui64>, tensor<f64>, tensor<f64>) -> (tensor<2xui64>, tensor<f64>)
// CHECK-NEXT:    %2 = call @logpdf(%1#1, %arg2, %arg3) : (tensor<f64>, tensor<f64>, tensor<f64>) -> tensor<f64>
...
// CHECK-NEXT:    %6 = call @logpdf(%5, %1#1, %arg3) : (tensor<f64>, tensor<f64>, tensor<f64>) -> tensor<f64>
...
// CHECK-NEXT:    return %10, %7, %1#0, %5 : !enzyme.Trace, tensor<f64>, tensor<2xui64>, tensor<f64>
// CHECK-NEXT:  }
