...
// BASE-NEXT: %[[RS2:.+]] = impulse.reshape %[[S2]]#1 : (tensor<f64>) -> tensor<1x1xf64>
...
// HIER-NEXT: %[[O_RS1:.+]] = impulse.reshape %[[O_S1]]#1 : (tensor<f64>) -> tensor<1x1xf64>
...
// HIER-NEXT: %[[I_RS1:.+]] = impulse.reshape %[[I_S1]]#1 : (tensor<f64>) -> tensor<1x1xf64>
...
// HIER-NEXT: %[[I_RS2:.+]] = impulse.reshape %[[I_S2]]#1 : (tensor<f64>) -> tensor<1x1xf64>
