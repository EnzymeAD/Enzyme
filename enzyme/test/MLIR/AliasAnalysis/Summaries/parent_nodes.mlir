...
// CHECK:         distinct[0]<#enzyme.pseudoclass<@get_posed_relatives(3, 1)>> originates from [#enzyme.argorigin<@get_posed_relatives(1)>, #enzyme.argorigin<@get_posed_relatives(2)>, #enzyme.argorigin<@get_posed_relatives(3)>]
// CHECK: backward value origins:
// CHECK:         distinct[0]<#enzyme.pseudoclass<@get_posed_relatives(1, 1)>> goes to [#enzyme.argorigin<@get_posed_relatives(1)>, #enzyme.argorigin<@get_posed_relatives(3)>]
// CHECK:         distinct[0]<#enzyme.pseudoclass<@get_posed_relatives(2, 1)>> goes to [#enzyme.argorigin<@get_posed_relatives(2)>, #enzyme.argorigin<@get_posed_relatives(3)>]
...
// CHECK: forward value origins:
// CHECK:         distinct[0]<#enzyme.pseudoclass<@apply_global_transform(1, 1)>> originates from [#enzyme.argorigin<@apply_global_transform(0)>, #enzyme.argorigin<@apply_global_transform(1)>]
// CHECK:         distinct[0]<"fresh-agt_tmp"> originates from [#enzyme.argorigin<@apply_global_transform(0)>, #enzyme.argorigin<@apply_global_transform(1)>]
// CHECK:         distinct[0]<"fresh-rmat_data"> originates from [#enzyme.argorigin<@apply_global_transform(0)>]
// CHECK: backward value origins:
// CHECK:         distinct[0]<#enzyme.pseudoclass<@apply_global_transform(0, 1)>> goes to [#enzyme.argorigin<@apply_global_transform(0)>, #enzyme.argorigin<@apply_global_transform(1)>]
// CHECK:         distinct[0]<"fresh-agt_tmp"> goes to [#enzyme.argorigin<@apply_global_transform(1)>]
// CHECK:         distinct[0]<"fresh-rmat_data"> goes to [#enzyme.argorigin<@apply_global_transform(1)>]
...
// CHECK: forward value origins:
// CHECK:         distinct[0]<#enzyme.pseudoclass<@get_skinned_vertex_positions(8, 1)>> originates from [#enzyme.argorigin<@get_skinned_vertex_positions(1)>, #enzyme.argorigin<@get_skinned_vertex_positions(3)>, #enzyme.argorigin<@get_skinned_vertex_positions(4)>, #enzyme.argorigin<@get_skinned_vertex_positions(5)>, #enzyme.argorigin<@get_skinned_vertex_positions(7)>, #enzyme.argorigin<@get_skinned_vertex_positions(8)>]
// CHECK: backward value origins:
// CHECK:         distinct[0]<#enzyme.pseudoclass<@get_skinned_vertex_positions(1, 0)>> goes to [#enzyme.argorigin<@get_skinned_vertex_positions(1)>, #enzyme.argorigin<@get_skinned_vertex_positions(8)>]
// CHECK:         distinct[0]<#enzyme.pseudoclass<@get_skinned_vertex_positions(3, 1)>> goes to [#enzyme.argorigin<@get_skinned_vertex_positions(3)>, #enzyme.argorigin<@get_skinned_vertex_positions(8)>]
// CHECK:         distinct[0]<#enzyme.pseudoclass<@get_skinned_vertex_positions(4, 1)>> goes to [#enzyme.argorigin<@get_skinned_vertex_positions(4)>, #enzyme.argorigin<@get_skinned_vertex_positions(8)>]
// CHECK:         distinct[0]<#enzyme.pseudoclass<@get_skinned_vertex_positions(5, 1)>> goes to [#enzyme.argorigin<@get_skinned_vertex_positions(5)>, #enzyme.argorigin<@get_skinned_vertex_positions(8)>]
// CHECK:         distinct[0]<#enzyme.pseudoclass<@get_skinned_vertex_positions(7, 0)>> goes to [#enzyme.argorigin<@get_skinned_vertex_positions(7)>, #enzyme.argorigin<@get_skinned_vertex_positions(8)>]
...
// CHECK: forward value origins:
// CHECK:         distinct[0]<#enzyme.pseudoclass<@hand_objective(13, 0)>> originates from [#enzyme.argorigin<@hand_objective(0)>, #enzyme.argorigin<@hand_objective(4)>, #enzyme.argorigin<@hand_objective(5)>, #enzyme.argorigin<@hand_objective(6)>, #enzyme.argorigin<@hand_objective(7)>, #enzyme.argorigin<@hand_objective(12)>, #enzyme.argorigin<@hand_objective(13)>]
// CHECK: backward value origins:
// CHECK:         distinct[0]<#enzyme.pseudoclass<@hand_objective(0, 0)>> goes to [#enzyme.argorigin<@hand_objective(0)>, #enzyme.argorigin<@hand_objective(13)>]
// CHECK:         distinct[0]<#enzyme.pseudoclass<@hand_objective(4, 0)>> goes to [#enzyme.argorigin<@hand_objective(4)>, #enzyme.argorigin<@hand_objective(13)>]
// CHECK:         distinct[0]<#enzyme.pseudoclass<@hand_objective(5, 0)>> goes to [#enzyme.argorigin<@hand_objective(5)>, #enzyme.argorigin<@hand_objective(13)>]
// CHECK:         distinct[0]<#enzyme.pseudoclass<@hand_objective(6, 0)>> goes to [#enzyme.argorigin<@hand_objective(6)>, #enzyme.argorigin<@hand_objective(13)>]
// CHECK:         distinct[0]<#enzyme.pseudoclass<@hand_objective(7, 0)>> goes to [#enzyme.argorigin<@hand_objective(7)>, #enzyme.argorigin<@hand_objective(13)>]
// CHECK:         distinct[0]<#enzyme.pseudoclass<@hand_objective(12, 1)>> goes to [#enzyme.argorigin<@hand_objective(12)>, #enzyme.argorigin<@hand_objective(13)>]
