...
TraceGenerator::TraceGenerator(EnzymeLogic &Logic, TraceUtils *const tutils)
...
void TraceGenerator::visitCallInst(llvm::CallInst &call) {
  ...
  if (call.getCalledFunction() ==
    ...
    auto score =
        Builder.CreateCall(loglikelihoodfn->getFunctionType(), loglikelihoodfn,
                           loglikelihood_args, "likelihood." + call.getName());
