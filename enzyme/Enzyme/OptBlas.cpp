...
bool optimizeFncsWithBlas(llvm::Module &M) {
  ...
  // IRBuilder<> BuilderZ(&called->getEntryBlock());
  // BuilderZ.setFastMathFlags(getFast());

  // BasicBlock *bb = called->getEntryBlock();
...
//bool OptimizeBlasNewPM::run(llvm::Module &M, llvm::ModuleAnalysisManager &MAM) {
//  bool changed = false;
//  for (auto &F : M)
//    changed |= optimizeBlas(Begin, F);
