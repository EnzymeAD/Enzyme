...
// Set to true to dump a graphviz representation of the mincut graph. Nice for
// debugging.
#define DEBUG_GRAPHVIZ false
...
void mlir::enzyme::minCutCache(Block *forward, Block *reverse,
  ...
  LLVM_DEBUG(if (DEBUG_GRAPHVIZ) annotate_ops(forward, reverse));
