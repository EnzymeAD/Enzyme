...
LLVMValueRef EnzymeCreateForwardDiff(
    ...
    CDerivativeMode mode, uint8_t freeMemory, uint8_t runtimeActivity, unsigned width,
  ...
  return wrap(eunwrap(Logic).CreateForwardDiff(
      ...
      eunwrap(TA), returnValue, (DerivativeMode)mode, freeMemory, runtimeActivity, width,
...
LLVMValueRef EnzymeCreatePrimalAndGradient(
    ...
    LLVMValueRef todiff, CDIFFE_TYPE retType, CDIFFE_TYPE *constant_args,
    size_t constant_args_size, EnzymeTypeAnalysisRef TA, uint8_t returnValue,
    uint8_t dretUsed, CDerivativeMode mode, uint8_t runtimeActivity, unsigned width, uint8_t freeMemory,
...
EnzymeAugmentedReturnPtr EnzymeCreateAugmentedPrimal(
    ...
    size_t overwritten_args_size, uint8_t forceAnonymousTape, uint8_t runtimeActivity,
    unsigned width,
    uint8_t AtomicAdd) {
