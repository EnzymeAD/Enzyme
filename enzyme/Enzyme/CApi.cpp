...
LLVMValueRef EnzymeCreateDual(EnzymeLogicRef Logic, LLVMValueRef todiff,
                              CDIFFE_TYPE retType, CDIFFE_TYPE *constant_args,
                              size_t constant_args_size,
                              EnzymeTypeAnalysisRef TA, uint8_t returnValue,
                              uint8_t dretUsed, CDerivativeMode mode,
                              LLVMTypeRef additionalArg, CFnTypeInfo typeInfo,
                              uint8_t *_uncacheable_args,
                              size_t uncacheable_args_size, uint8_t AtomicAdd,
                              uint8_t PostOpt) {
  ...
  return wrap(eunwrap(Logic).CreateDual(
