...
/// align is the alignment that should be specified for load/store to pointer
  ...
  void addToInvertedPtrDiffe(llvm::Instruction *orig, llvm::Value *origVal, llvm::Type *addingType,
...
#if LLVM_VERSION_MAJOR >= 10
  void addToInvertedPtrDiffe(llvm::Instruction *orig, llvm::Value *origVal, TypeTree vd,
