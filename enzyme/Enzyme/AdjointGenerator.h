...
#endif
  {
    ...
    if (Mode == DerivativeMode::ForwardMode) {
      ...
      gutils->setPtrDiffe(&I, orig_ptr, diff, Builder2, align, isVolatile,
                          ordering, syncScope, start, size, mask);
      return;
    }
    ...
    while (1) {
      ...
      // TODO partial make the next parts
      ...
      if (Type *FT = dt.isFloat()) {
        ...
        case DerivativeMode::ReverseModeCombined: {
          ...
          if (constantval) {
            gutils->setPtrDiffe(
                ...
                Builder2, align, isVolatile, ordering, syncScope, start, size,
                mask);
          } else {
            Value *diff;
            if (!mask) {
        ...
        if ((Mode == DerivativeMode::ReverseModePrimal && forwardsShadow) ||
          ...
          gutils->setPtrDiffe(&I, orig_ptr, valueop, storeBuilder, align,
                              isVolatile, ordering, syncScope, start, size,
                              mask);
        }
      }
    }
  ...
  for (int i = 0; i < 2; i++)
    if (auto P0 = dyn_cast<PHINode>(SI.getOperand(i + 1))) {
      ...
      if (activeUses.size() == 1 && activeUses[0] == &SI &&
          gutils->getContext(gutils->getNewFromOriginal(P0->getParent()), lc) &&
...
void visitExtractElementInst(llvm::ExtractElementInst &EEI) {
  ...
  case DerivativeMode::ReverseModeCombined: {
    ...
    setDiffe(&EEI, Constant::getNullValue(gutils->getShadowType(EEI.getType())),
             Builder2);
    return;
  }
  case DerivativeMode::ReverseModePrimal: {
...
void visitInsertElementInst(llvm::InsertElementInst &IEI) {
  ...
  case DerivativeMode::ReverseModeCombined: {
    ...
    setDiffe(&IEI, Constant::getNullValue(gutils->getShadowType(IEI.getType())),
             Builder2);
    return;
  }
  case DerivativeMode::ReverseModePrimal: {
...
void visitShuffleVectorInst(llvm::ShuffleVectorInst &SVI) {
  ...
  case DerivativeMode::ReverseModeCombined: {
    ...
    setDiffe(&SVI, Constant::getNullValue(gutils->getShadowType(SVI.getType())),
             Builder2);
    return;
  }
  case DerivativeMode::ReverseModePrimal: {
...
void visitExtractValueInst(llvm::ExtractValueInst &EVI) {
  ...
  case DerivativeMode::ReverseModeCombined: {
    ...
    setDiffe(&EVI, Constant::getNullValue(gutils->getShadowType(EVI.getType())),
             Builder2);
    return;
  }
  case DerivativeMode::ReverseModePrimal: {
...
void visitInsertValueInst(llvm::InsertValueInst &IVI) {
  ...
  case DerivativeMode::ReverseModeGradient: {
    ...
    setDiffe(&IVI, Constant::getNullValue(gutils->getShadowType(IVI.getType())),
             Builder2);
    return;
  }
  case DerivativeMode::ReverseModePrimal: {
...
void applyChainRule(ArrayRef<Value *> diffs, IRBuilder<> &Builder, Func rule) {
...
void createBinaryOperatorAdjoint(llvm::BinaryOperator &BO) {
  ...
  case Instruction::FMul: {
    if (!constantval0) {
      ...
      auto rule = [&](Value *idiff) {
        return Builder2.CreateFMul(idiff, op0, "m0diffe" + orig_op0->getName());
      };
  ...
  case Instruction::FDiv: {
    ...
    if (!constantval0) {
      ...
      auto rule = [&](Value *idiff) {
        return Builder2.CreateFDiv(idiff, op1, "d0diffe" + orig_op0->getName());
      };
      dif0 = applyChainRule(orig_op0->getType(), Builder2, rule, idiff);
    }
    if (!constantval1) {
  ...
  case Instruction::And: {
    ...
    if (FT)
      for (int i = 0; i < 2; ++i) {
        ...
        if (CI &&
            dl.getTypeSizeInBits(eFT) == dl.getTypeSizeInBits(CI->getType())) {
      ...
      for (int i = 0; i < 2; ++i) {
        ...
        if (auto CV = dyn_cast<ConstantVector>(BO.getOperand(i))) {
          ...
          if (validXor) {
            ...
            Value *V = applyChainRule(BO.getOperand(1 - i)->getType(), Builder2,
                                      rule, idiff);
      ...
      for (int i = 0; i < 2; ++i) {
        ...
        if (CI &&
          ...
          if (validXor) {
            ...
            auto arg = lookup(gutils->getNewFromOriginal(BO.getOperand(1 - i)),
                              Builder2);
  ...
  case Instruction::FMul: {
    if (!constantval0 && !constantval1) {
      ...
      auto rule = [&](Value *dif0) {
        return Builder2.CreateFMul(dif0, gutils->getNewFromOriginal(orig_op1));
      };
      ...
      auto rule = [&](Value *dif1) {
        return Builder2.CreateFMul(dif1, gutils->getNewFromOriginal(orig_op0));
      };
        ...
        if (CI &&
          ...
          if (CI->isNegative() && CI->isMinValue(/*signed*/ true)) {
            ...
            auto rule = [&](Value *difi) {
              auto neg = Builder2.CreateFNeg(Builder2.CreateBitCast(difi, FT));
              return Builder2.CreateBitCast(neg, BO.getType());
            };
...
known:;
  ...
  while (1) {
    ...
    if (start != 0)
      length = BuilderZ.CreateSub(length,
                                  ConstantInt::get(new_size->getType(), start));
  ...
  if (Mode == DerivativeMode::ForwardMode) {
    ...
    auto rule = [&](Value *ddst, Value *dsrc) {
      ...
      if (ID == Intrinsic::memmove) {
        call = Builder2.CreateMemMove(ddst, dstAlign, dsrc, srcAlign, new_size);
      } else {
        call = Builder2.CreateMemCpy(ddst, dstAlign, dsrc, srcAlign, new_size);
      }
...
void visitIntrinsicInst(llvm::IntrinsicInst &II) {
  ...
  if (gutils->knownRecomputeHeuristic.find(&II) !=
    ...
    if (!gutils->knownRecomputeHeuristic[&II]) {
      CallInst *const newCall = cast<CallInst>(gutils->getNewFromOriginal(&II));
...
void handleAdjointForIntrinsic(Intrinsic::ID ID, llvm::Instruction &I,
  ...
  case DerivativeMode::ReverseModeGradient: {
    ...
    case Intrinsic::nvvm_barrier0_or: {
      ...
      cal->setCallingConv(Intrinsic::getDeclaration(M, Intrinsic::nvvm_barrier0)
                              ->getCallingConv());
    ...
    case Intrinsic::maxnum: {
      ...
      if (vdiff && !gutils->isConstantValue(orig_ops[1])) {
        ...
        Value *dif1 =
            Builder2.CreateSelect(cmp, vdiff,
                                  Constant::getNullValue(gutils->getShadowType(
                                      orig_ops[1]->getType())));
    ...
    case Intrinsic::fma: {
      if (vdiff && !gutils->isConstantValue(orig_ops[0])) {
        Value *op1 = lookup(gutils->getNewFromOriginal(orig_ops[1]), Builder2);
        auto rule = [&](Value *vdiff) {
      ...
      if (vdiff && !gutils->isConstantValue(orig_ops[1])) {
        Value *op0 = lookup(gutils->getNewFromOriginal(orig_ops[0]), Builder2);
        auto rule = [&](Value *vdiff) {
      ...
      if (vdiff && !gutils->isConstantValue(orig_ops[2])) {
        addToDiffe(orig_ops[2], vdiff, Builder2, I.getType()->getScalarType());
      }
      return;
    }
    ...
    case Intrinsic::copysign: {
      if (vdiff && !gutils->isConstantValue(orig_ops[0])) {
        ...
        auto rule = [&](Value *vdiff) {
          return Builder2.CreateFMul(Builder2.CreateFMul(xsign, ysign), vdiff);
        };
        Value *dif0 =
            applyChainRule(orig_ops[0]->getType(), Builder2, rule, vdiff);
        addToDiffe(orig_ops[0], dif0, Builder2, I.getType());
  ...
  case DerivativeMode::ForwardMode: {
...
#endif
    {
      ...
      Value *dif = applyChainRule(I.getType(), Builder2, rule, accdif, vecdif);
    ...
    case Intrinsic::sqrt: {
      ...
      auto rule = [&](Value *op) {
        ...
        return Builder2.CreateSelect(cmp, Constant::getNullValue(opType), dif0);
      };
    ...
    case Intrinsic::maxnum: {
      ...
      Value *dif = applyChainRule(I.getType(), Builder2, rule, diffe0, diffe1);
      setDiffe(&I, dif, Builder2);
      return;
    }
    ...
    case Intrinsic::fma: {
      ...
      auto rule = [&](Value *dif0, Value *dif1, Value *dif2) {
        Value *dif = Builder2.CreateFAdd(gutils->isConstantValue(orig_ops[1])
                                             ? Constant::getNullValue(opType1)
    ...
    case Intrinsic::powi: {
      ...
      if (!gutils->isConstantValue(orig_ops[0])) {
        ...
        Value *op1 = gutils->getNewFromOriginal(orig_ops[1]);
        SmallVector<Value *, 2> args = {
            op0, Builder2.CreateSub(op1, ConstantInt::get(op1->getType(), 1))};
        auto &CI = cast<CallInst>(I);
#if LLVM_VERSION_MAJOR >= 11
        auto *PowF = CI.getCalledOperand();
#else
        ...
        Value *cmp =
            Builder2.CreateICmpEQ(ConstantInt::get(args[1]->getType(), 0), op1);
        auto rule = [&](Value *op) {
    ...
    case Intrinsic::pow: {
      ...
      Value *res = Constant::getNullValue(gutils->getShadowType(CI.getType()));

      auto &DL = gutils->newFunc->getParent()->getDataLayout();

      if (!gutils->isConstantValue(orig_ops[0])) {
        Value *args[2] = {op0, Builder2.CreateFSub(
                                   op1, ConstantFP::get(op1->getType(), 1.0))};
...
void visitOMPCall(llvm::CallInst &call) {
  ...
  if (task->empty()) {
    llvm::errs() << "could not derive underlying task contents from omp call: "
                 << call << "\n";
    ...
    if (argTy == DIFFE_TYPE::DUP_ARG || argTy == DIFFE_TYPE::DUP_NONEED) {
      if (Mode != DerivativeMode::ReverseModePrimal) {
        ...
        args.push_back(lookup(
            gutils->invertPointerM(call.getArgOperand(i), Builder2), Builder2));
      }
      pre_args.push_back(
  ...
  if (Mode == DerivativeMode::ReverseModeGradient ||
    ...
    if (called) {
      if (subdata->returns.find(AugmentedStruct::Tape) !=
        ...
        auto alloc =
            IRBuilder<>(gutils->inversionAllocs).CreateAlloca(tape->getType());
...
knownF:;
  ...
  while (1) {
    ...
    if (start != 0)
      length = Builder2.CreateSub(length,
                                  ConstantInt::get(len_arg->getType(), start));

    if (auto secretty = dt.isFloat()) {
      auto offset = start;
      if (dsto->getType()->isIntegerTy())
        dsto = Builder2.CreateIntToPtr(dsto,
                                       Type::getInt8PtrTy(dsto->getContext()));
      ...
      if (srco->getType()->isIntegerTy())
        srco = Builder2.CreateIntToPtr(srco,
                                       Type::getInt8PtrTy(dsto->getContext()));
  ...
  if (funcName == "ddot" || funcName == "sdot") {
    if (!gutils->isConstantInstruction(&call)) {
      ...
      if ((Mode == DerivativeMode::ReverseModeCombined ||
        ...
        if (byRef) {
          xinc =
              BuilderZ.CreatePointerCast(xinc, PointerType::getUnqual(intType));
#if LLVM_VERSION_MAJOR > 7
        ...
        if (byRef) {
          yinc =
              BuilderZ.CreatePointerCast(yinc, PointerType::getUnqual(intType));
#if LLVM_VERSION_MAJOR > 7
        ...
        if (cacheValues.size() == 1)
          ...
          for (auto tup : llvm::enumerate(cacheValues))
            cacheval =
                BuilderZ.CreateInsertValue(cacheval, tup.value(), tup.index());
        }
      ...
      if (Mode == DerivativeMode::ReverseModeCombined ||
        ...
        if (cachetype) {
          ...
          cacheval = gutils->cacheForReverse(BuilderZ, cacheval,
                                             getIndex(&call, CacheType::Tape));
      ...
      if (Mode == DerivativeMode::ReverseModeCombined ||
        ...
        if (xcache) {
          ...
          if (byRef) {
            ...
            xinc = Builder2.CreatePointerCast(alloc,
        ...
        if (ycache) {
          ...
          if (byRef) {
            ...
            yinc = Builder2.CreatePointerCast(alloc,
                                              call.getArgOperand(0)->getType());
          }
        ...
        if (call.getArgOperand(1)->getType()->isIntegerTy())
          xdata =
              Builder2.CreatePtrToInt(xdata, call.getArgOperand(1)->getType());
        if (call.getArgOperand(3)->getType()->isIntegerTy())
          ydata =
              Builder2.CreatePtrToInt(ydata, call.getArgOperand(3)->getType());
      }
      ...
      if (Mode == DerivativeMode::ReverseModeCombined ||
        ...
        auto derivcall = gutils->oldFunc->getParent()->getOrInsertFunction(
            ...
            call.getArgOperand(1)->getType(), call.getArgOperand(0)->getType(),
            call.getArgOperand(3)->getType(), call.getArgOperand(0)->getType());
#if LLVM_VERSION_MAJOR >= 9
        if (auto F = dyn_cast<Function>(derivcall.getCallee()))
#else
        if (auto F = dyn_cast<Function>(derivcall))
...
#if LLVM_VERSION_MAJOR > 7
      Value *cache =
          Builder2.CreateLoad(d_req->getType()->getPointerElementType(), d_req);
#else
...
#if LLVM_VERSION_MAJOR == 6
      auto align_arg = ConstantInt::get(Type::getInt32Ty(call.getContext()), 1);
...
#include "InstructionDerivatives.inc"
    ...
    if (funcName == "__mulsc3" || funcName == "__muldc3" ||
      ...
      case DerivativeMode::ForwardModeSplit: {
        ...
        Value *res = Builder2.CreateInsertValue(UndefValue::get(call.getType()),
                                                resReal, {0});
    ...
    if (called) {
        ...
        case DerivativeMode::ReverseModeCombined: {
          ...
          if (funcName.startswith("Faddeeva")) {
            ...
            cal = Builder2.CreateInsertValue(
                cal,
                Builder2.CreateFMul(reexp, Builder2.CreateCall(CosF, {im})), 0);
            cal = Builder2.CreateInsertValue(
                cal,
                Builder2.CreateFMul(reexp, Builder2.CreateCall(SinF, {im})), 1);
          } else {
      ...
      if (funcName == "j0" || funcName == "y0" || funcName == "j0f" ||
        ...
        case DerivativeMode::ReverseModeCombined: {
          ...
          dx = applyChainRule(orig->getArgOperand(0)->getType(), Builder2, rule,
                              dorig);
          setDiffe(
              orig,
              Constant::getNullValue(gutils->getShadowType(orig->getType())),
      ...
      if (funcName == "jn" || funcName == "yn" || funcName == "jnf" ||
        ...
        case DerivativeMode::ReverseModeCombined: {
          ...
          Value *dorig = diffe(orig, Builder2);
          dx = applyChainRule(orig->getArgOperand(1)->getType(), Builder2, rule,
                              dorig);
          setDiffe(
              orig,
              Constant::getNullValue(gutils->getShadowType(orig->getType())),
      ...
      if (funcName == "ldexp" || funcName == "ldexpf" || funcName == "ldexpl") {
        if (gutils->knownRecomputeHeuristic.find(orig) !=
            gutils->knownRecomputeHeuristic.end()) {
          if (!gutils->knownRecomputeHeuristic[orig]) {
            gutils->cacheForReverse(BuilderZ, newCall,
      ...
      if (Mode == DerivativeMode::ReverseModeCombined ||
        ...
        }
        {
          ...
          if (shadowHandlers.find(funcName.str()) != shadowHandlers.end()) {
            ...
            if (!backwardsShadow)
              anti = gutils->cacheForReverse(bb, anti,
                                             getIndex(orig, CacheType::Shadow));
          } else {
            auto rule = [&]() {
#if LLVM_VERSION_MAJOR >= 11
  ...
  if (funcName == "posix_memalign") {
    ...
    if (!constval) {
      ...
      if (Mode == DerivativeMode::ReverseModePrimal ||
...
#if LLVM_VERSION_MAJOR > 7
        val = BuilderZ.CreateLoad(ptrshadow->getType()->getPointerElementType(),
                                  ptrshadow);
#else
        ...
        auto dst_arg =
            BuilderZ.CreateBitCast(val, Type::getInt8PtrTy(call.getContext()));
        auto val_arg = ConstantInt::get(Type::getInt8Ty(call.getContext()), 0);
        auto len_arg = BuilderZ.CreateZExtOrTrunc(
            gutils->getNewFromOriginal(call.getArgOperand(2)),
            Type::getInt64Ty(call.getContext()));
  ...
  if (Mode == DerivativeMode::ForwardMode ||
    ...
    if (called) {
      ...
      ReturnType subretVal =
          subretused ? (retActive ? ReturnType::TwoReturns : ReturnType::Return)
      ...
      newcalled =
          BuilderZ.CreatePointerCast(newcalled, PointerType::getUnqual(fptype));
#if LLVM_VERSION_MAJOR > 7
...
#endif
  {
    ...
    auto argTy = gutils->getDiffeType(orig->getArgOperand(i), foreignFunction);
    ...
    if (argTy == DIFFE_TYPE::DUP_ARG || argTy == DIFFE_TYPE::DUP_NONEED) {
      ...
      if (Mode != DerivativeMode::ReverseModePrimal) {
        ...
        if (writeOnlyNoCapture && !replaceFunction &&
          ...
          if (EnzymeZeroCache)
            darg = ConstantPointerNull::get(cast<PointerType>(argi->getType()));
          else
  ...
  if (modifyPrimal) {
    ...
    if (/*!topLevel*/ Mode != DerivativeMode::ReverseModeCombined &&
      ...
      if (is_value_needed_in_reverse<ValueType::Primal>(gutils, orig, Mode,
        ...
        auto pn = BuilderZ.CreatePHI(orig->getType(), 1,
                                     (orig->getName() + "_replacementC").str());
        gutils->fictiousPHIs[pn] = orig;
        cachereplace = pn;
      }
    }
  ...
  if (called) {
    ...
    auto fptype = PointerType::getUnqual(
        FunctionType::get(StructType::get(newcalled->getContext(), res.second),
                          res.first, ft->isVarArg()));
    newcalled =
...
#if LLVM_VERSION_MAJOR > 7
  CallInst *diffes = Builder2.CreateCall(
      FT, newcalled, args,
      gutils->getInvertedBundles(orig, BundleTypes, Builder2, /*lookup*/ true));
#else
  CallInst *diffes = Builder2.CreateCall(
      newcalled, args,
      gutils->getInvertedBundles(orig, BundleTypes, Builder2, /*lookup*/ true));
    ...
    for (auto a : postCreate) {
      ...
      if (orig_a) {
        for (unsigned i = 0; i < a->getNumOperands(); ++i) {
          a->setOperand(
              i,
              gutils->unwrapM(gutils->getNewFromOriginal(orig_a->getOperand(i)),
