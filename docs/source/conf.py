...
html_theme = 'enzyme_sphinx_theme'
...
htmlhelp_basename = 'EnzymeSphinxthemedemodoc'
...
latex_documents = [
  ('index', 'Enzymethemedemo.tex', u'Enzyme theme demo Documentation',
   u'Enzyme, Enzyme', 'manual'),
]
...
man_pages = [
    ('index', 'enzymethemedemo', u'Enzyme theme demo Documentation',
     [u'Enzyme'], 1)
]
