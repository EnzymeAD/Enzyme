//===- LowerAutoDiffIntrinsic.h - LowerExpectIntrinsic pass -------*- C++ -*-===//
//
...
#ifndef LLVM_TRANSFORMS_SCALAR_LOWERAUTODIFFINTRINSIC_H
#define LLVM_TRANSFORMS_SCALAR_LOWERAUTODIFFINTRINSIC_H
...
struct LowerAutodiffIntrinsicPass : PassInfoMixin<LowerAutodiffIntrinsicPass> {
