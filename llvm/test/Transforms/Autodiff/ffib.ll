; RUN: opt < %s -load=%llvmshlibdir/LLVMEnzyme%shlibext -enzyme -mem2reg -instsimplify -simplifycfg -early-cse -dce -correlated-propagation -instcombine -loop-deletion -simplifycfg -S | FileCheck %s
...
entry:
  ...
  %1 = tail call double (double (i32, double)*, ...) @llvm.autodiff.p0f_f64i32f64f(double (i32, double)* nonnull @ffib, i32 %conv.i, double 1.000000e+00)
...
; Function Attrs: nounwind
declare double @llvm.autodiff.p0f_f64i32f64f(double (i32, double)*, ...) #3
