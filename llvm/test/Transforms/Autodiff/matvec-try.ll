...
entry:
  %0 = tail call double (void (i64, i64, double*, double*, double*)*, ...) @llvm.autodiff.p0f_isVoidi64i64p0f64p0f64p0f64f(void (i64, i64, double*, double*, double*)* nonnull @matvec, i64 %N, i64 %M, double* %mat, double* %matp, double* %vec, double* %vecp, double* %out, double* %outp)
  ret void
}

; Function Attrs: nounwind
declare double @llvm.autodiff.p0f_isVoidi64i64p0f64p0f64p0f64f(void (i64, i64, double*, double*, double*)*, ...) #2
