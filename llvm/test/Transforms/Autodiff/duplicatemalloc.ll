...
entry:
  %0 = tail call double (double (double, i64)*, ...) @llvm.autodiff.p0f_f64f64i64f(double (double, i64)* nonnull @malloced, double %x, i64 %n)
  ret void
}
...
; CHECK-NEXT:   %call2.i = tail call i32 (double*, ...) bitcast (i32 (...)* @free to i32 (double*, ...)*)(double* %0) #6
