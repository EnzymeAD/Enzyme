; RUN: opt < %s -lower-autodiff -inline -mem2reg -sroa -adce -aggressive-instcombine -instsimplify -correlated-propagation -early-cse-memssa -instcombine -loop-deletion -simplifycfg -S | FileCheck %s
...
; Function Attrs: nounwind
declare double @llvm.autodiff.p0f_f64f64i32f(double (double, i32)*, ...) #4
...
; CHECK-NEXT:   %"call'mi" = call noalias i8* @malloc(i64 8) #4
