; RUN: opt < %s -load=%llvmshlibdir/LLVMEnzyme%shlibext -enzyme -inline -mem2reg -sroa -adce -aggressive-instcombine -instsimplify -correlated-propagation -early-cse-memssa -instcombine -loop-deletion -simplifycfg -S | FileCheck %s
