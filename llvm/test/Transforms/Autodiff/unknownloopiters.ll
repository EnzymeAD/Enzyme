...
entry:
  %0 = tail call double (double (double*)*, ...) @llvm.autodiff.p0f_f64p0f64f(double (double*)* nonnull @unknowniters, double* %x, double* %xp)
  ret void
}

; Function Attrs: nounwind
declare double @llvm.autodiff.p0f_f64p0f64f(double (double*)*, ...) #2
