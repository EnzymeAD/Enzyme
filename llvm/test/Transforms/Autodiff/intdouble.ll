; RUN: opt < %s -load=%llvmshlibdir/LLVMEnzyme%shlibext -enzyme -mem2reg -instsimplify -early-cse -simplifycfg -S | FileCheck %s
...
entry:
  %0 = tail call double (double (i64*)*, ...) @llvm.autodiff.p0f_f64p0i64f(double (i64*)* nonnull @intcast, metadata !"diffe_dup", i64* %x, i64* %xp)
  ret void
}

; Function Attrs: nounwind
declare double @llvm.autodiff.p0f_f64p0i64f(double (i64*)*, ...) #3
