; RUN: opt < %s -load=%llvmshlibdir/LLVMEnzyme%shlibext -enzyme -inline -mem2reg -instsimplify -gvn -dse -dse -S | FileCheck %s
...
entry:
  %0 = tail call double (void (double*)*, ...) @llvm.autodiff.p0f_isVoidp0f64f(void (double*)* nonnull @addOneMem, double* %x, double* %xp)
  ret void
}

; Function Attrs: nounwind
declare double @llvm.autodiff.p0f_isVoidp0f64f(void (double*)*, ...)
